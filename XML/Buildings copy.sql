...
VALUES	
	('BUILDINGCLASS_FW_SERVER_HUB',				'BUILDING_FW_SERVER_HUB',				'TXT_KEY_BUILDING_FW_SERVER_HUB'),
	('BUILDINGCLASS_FW_ENTERTAINMENT_SERVER',	'BUILDING_FW_ENTERTAINMENT_SERVER',		'TXT_KEY_BUILDING_FW_ENTERTAINMENT_SERVER'),
	('BUILDINGCLASS_FW_COMMERCE_SERVER',		'BUILDING_FW_COMMERCE_SERVER',			'TXT_KEY_BUILDING_FW_COMMERCE_SERVER'),
	('BUILDINGCLASS_FW_CLOUD_COMPUTING',		'BUILDING_FW_CLOUD_COMPUTING',			'TXT_KEY_BUILDING_FW_CLOUD_COMPUTING'),
	('BUILDINGCLASS_FW_RESEARCH_SERVER',		'BUILDING_FW_RESEARCH_SERVER',			'TXT_KEY_BUILDING_FW_RESEARCH_SERVER'),
	('BUILDINGCLASS_FW_GENE_LAB',				'BUILDING_FW_GENE_LAB',					'TXT_KEY_BUILDING_FW_GENE_LAB'),
	('BUILDINGCLASS_FW_CYBERPOLICE',			'BUILDING_FW_CYBERPOLICE',				'TXT_KEY_BUILDING_FW_CYBERPOLICE'),
	('BUILDINGCLASS_FW_NANOMAT_PLANT',			'BUILDING_FW_NANOMAT_PLANT',			'TXT_KEY_BUILDING_FW_NANOMAT_PLANT'),
	('BUILDINGCLASS_FW_AQUACULTURE_LAB',		'BUILDING_FW_AQUACULTURE_LAB',			'TXT_KEY_BUILDING_FW_AQUACULTURE_LAB'),
	('BUILDINGCLASS_FW_FUNGAL_AGRIGENOMICS',	'BUILDING_FW_FUNGAL_AGRIGENOMICS',		'TXT_KEY_BUILDING_FW_FUNGAL_AGRIGENOMICS'),
	('BUILDINGCLASS_FW_CRYPTOBANK',				'BUILDING_FW_CRYPTOBANK',				'TXT_KEY_BUILDING_FW_CRYPTOBANK'),
	('BUILDINGCLASS_FW_UNDERSEA_MINING',		'BUILDING_FW_UNDERSEA_MINING',			'TXT_KEY_BUILDING_FW_UNDERSEA_MINING'),
	('BUILDINGCLASS_FW_AUTOPLANT',				'BUILDING_FW_AUTOPLANT',				'TXT_KEY_BUILDING_FW_AUTOPLANT'),
	('BUILDINGCLASS_FW_VR_TRAINING',			'BUILDING_FW_VR_TRAINING',				'TXT_KEY_BUILDING_FW_VR_TRAINING'),
	('BUILDINGCLASS_FW_VIRTUAL_MUSEUM',		'BUILDING_FW_VIRTUAL_MUSEUM',			'TXT_KEY_BUILDING_FW_VIRTUAL_MUSEUM'),
	('BUILDINGCLASS_FW_NANOFORGE',			'BUILDING_FW_NANOFORGE',				'TXT_KEY_BUILDING_FW_NANOFORGE'),
	('BUILDINGCLASS_FW_PARTICLE_ACCELERATOR',	'BUILDING_FW_PARTICLE_ACCELERATOR',		'TXT_KEY_BUILDING_FW_PARTICLE_ACCELERATOR'),
	('BUILDINGCLASS_FW_VERTICAL_FARM',		'BUILDING_FW_VERTICAL_FARM',			'TXT_KEY_BUILDING_FW_VERTICAL_FARM'),
	('BUILDINGCLASS_FW_SEAWATER_ARTIFICIAL_REEF','BUILDING_FW_SEAWATER_ARTIFICIAL_REEF',	'TXT_KEY_BUILDING_FW_SEAWATER_ARTIFICIAL_REEF'),
	('BUILDINGCLASS_FW_ECOSANCTUARY',		'BUILDING_FW_ECOSANCTUARY',			'TXT_KEY_BUILDING_FW_ECOSANCTUARY'),
	('BUILDINGCLASS_FW_BIOFACTORY',			'BUILDING_FW_BIOFACTORY',				'TXT_KEY_BUILDING_FW_BIOFACTORY'),
	('BUILDINGCLASS_FW_IMPLANT_CLINIC',		'BUILDING_FW_IMPLANT_CLINIC',			'TXT_KEY_BUILDING_FW_IMPLANT_CLINIC'),
	('BUILDINGCLASS_FW_TELEPRESENCE_HUB',		'BUILDING_FW_TELEPRESENCE_HUB',			'TXT_KEY_BUILDING_FW_TELEPRESENCE_HUB'),
	('BUILDINGCLASS_FW_NETWORK_BACKBONE',	'BUILDING_FW_NETWORK_BACKBONE',			'TXT_KEY_BUILDING_FW_NETWORK_BACKBONE'),
	('BUILDINGCLASS_FW_BOREHOLE',			'BUILDING_FW_BOREHOLE',				'TXT_KEY_BUILDING_FW_BOREHOLE'),
	('BUILDINGCLASS_FW_GEOTHERMAL_FACTORY',	'BUILDING_FW_GEOTHERMAL_FACTORY',		'TXT_KEY_BUILDING_FW_GEOTHERMAL_FACTORY'),
	('BUILDINGCLASS_FW_HYDROTHERMAL_FACTORY','BUILDING_FW_HYDROTHERMAL_FACTORY',	'TXT_KEY_BUILDING_FW_HYDROTHERMAL_FACTORY'),
	('BUILDINGCLASS_FW_LAUNCH_FACILITY',		'BUILDING_FW_LAUNCH_FACILITY',			'TXT_KEY_BUILDING_FW_LAUNCH_FACILITY'),
	('BUILDINGCLASS_FW_CLONE_LAB',			'BUILDING_FW_CLONE_LAB',				'TXT_KEY_BUILDING_FW_CLONE_LAB'),
	('BUILDINGCLASS_FW_BIOFLESH_INDUSTRY',	'BUILDING_FW_BIOFLESH_INDUSTRY',		'TXT_KEY_BUILDING_FW_BIOFLESH_INDUSTRY'),
	('BUILDINGCLASS_FW_GENEJACK_FACILITY',	'BUILDING_FW_GENEJACK_FACILITY',		'TXT_KEY_BUILDING_FW_GENEJACK_FACILITY'),
	('BUILDINGCLASS_FW_CONVERTER',			'BUILDING_FW_CONVERTER',				'TXT_KEY_BUILDING_FW_CONVERTER'),
	('BUILDINGCLASS_FW_CONVERTER_OIL',		'BUILDING_FW_CONVERTER_OIL',			'TXT_KEY_BUILDING_FW_CONVERTER_OIL'),
	('BUILDINGCLASS_FW_CONVERTER_IRON',		'BUILDING_FW_CONVERTER_IRON',			'TXT_KEY_BUILDING_FW_CONVERTER_IRON'),
	('BUILDINGCLASS_FW_METROPLEX_HUB',		'BUILDING_FW_METROPLEX_HUB',			'TXT_KEY_BUILDING_FW_METROPLEX_HUB'),
	('BUILDINGCLASS_FW_FEEDSITE_HUB',		'BUILDING_FW_FEEDSITE_HUB',			'TXT_KEY_BUILDING_FW_FEEDSITE_HUB'),
	('BUILDINGCLASS_FW_DISTRIBUTION_HUB',	'BUILDING_FW_DISTRIBUTION_HUB',		'TXT_KEY_BUILDING_FW_DISTRIBUTION_HUB'),
	('BUILDINGCLASS_FW_SIMULATION_HUB',		'BUILDING_FW_SIMULATION_HUB',			'TXT_KEY_BUILDING_FW_SIMULATION_HUB'),
	('BUILDINGCLASS_FW_ENRICHMENT_FACILITY',	'BUILDING_FW_ENRICHMENT_FACILITY',		'TXT_KEY_BUILDING_FW_ENRICHMENT_FACILITY'),
	('BUILDINGCLASS_FW_SPACE_STATION',		'BUILDING_FW_SPACE_STATION',			'TXT_KEY_BUILDING_FW_SPACE_STATION'),
	('BUILDINGCLASS_FW_MYCOPROTEIN_VATS',	'BUILDING_FW_MYCOPROTEIN_VATS',		'TXT_KEY_BUILDING_FW_MYCOPROTEIN_VATS'),
	('BUILDINGCLASS_FW_RESEARCH_MODULE',		'BUILDING_FW_RESEARCH_MODULE',			'TXT_KEY_BUILDING_FW_RESEARCH_MODULE'),
	('BUILDINGCLASS_FW_ENGINEERING_MODULE',	'BUILDING_FW_ENGINEERING_MODULE',		'TXT_KEY_BUILDING_FW_ENGINEERING_MODULE'),
	('BUILDINGCLASS_FW_COMM_MODULE',			'BUILDING_FW_COMM_MODULE',				'TXT_KEY_BUILDING_FW_COMM_MODULE'),
	('BUILDINGCLASS_FW_TIDAL_PORT',			'BUILDING_FW_TIDAL_PORT',				'TXT_KEY_BUILDING_FW_TIDAL_PORT'),
	('BUILDINGCLASS_FW_CYBERCLINIC',			'BUILDING_FW_CYBERCLINIC',				'TXT_KEY_BUILDING_FW_CYBERCLINIC'),
	('BUILDINGCLASS_FW_HIGHSPEED_RAIL',		'BUILDING_FW_HIGHSPEED_RAIL',			'TXT_KEY_BUILDING_FW_HIGHSPEED_RAIL'),
	('BUILDINGCLASS_FW_AEROSPACE_COMPLEX',	'BUILDING_FW_AEROSPACE_COMPLEX',		'TXT_KEY_BUILDING_FW_AEROSPACE_COMPLEX'),
	('BUILDINGCLASS_FW_TRANSGENIC_NURSERY',	'BUILDING_FW_TRANSGENIC_NURSERY',		'TXT_KEY_BUILDING_FW_TRANSGENIC_NURSERY'),
	('BUILDINGCLASS_FW_DRONE_HIVE',			'BUILDING_FW_DRONE_HIVE',				'TXT_KEY_BUILDING_FW_DRONE_HIVE'),
	('BUILDINGCLASS_FW_NANOMINES_FIELD',	'BUILDING_FW_NANOMINES_FIELD',				'TXT_KEY_BUILDING_FW_NANOMINES_FIELD'),
	('BUILDINGCLASS_FW_DEFENSE_FIELD',		'BUILDING_FW_DEFENSE_FIELD',			'TXT_KEY_BUILDING_FW_DEFENSE_FIELD'),
	('BUILDINGCLASS_FW_ECTOGENESIS_POD',		'BUILDING_FW_ECTOGENESIS_POD',			'TXT_KEY_BUILDING_FW_ECTOGENESIS_POD'),
	('BUILDINGCLASS_FW_MASS_DIGESTER',		'BUILDING_FW_MASS_DIGESTER',			'TXT_KEY_BUILDING_FW_MASS_DIGESTER'),
	('BUILDINGCLASS_FW_BIOMOD_TANK',			'BUILDING_FW_BIOMOD_TANK',				'TXT_KEY_BUILDING_FW_BIOMOD_TANK'),
	('BUILDINGCLASS_FW_DIGITAL_POLICE',		'BUILDING_FW_DIGITAL_POLICE',			'TXT_KEY_BUILDING_FW_DIGITAL_POLICE'),
	('BUILDINGCLASS_FW_FUSION_PLANT',		'BUILDING_FW_FUSION_PLANT',				'TXT_KEY_BUILDING_FW_FUSION_PLANT'),
	('BUILDINGCLASS_FW_ORBITAL_HABITAT',		'BUILDING_FW_ORBITAL_HABITAT',			'TXT_KEY_BUILDING_FW_ORBITAL_HABITAT'),
	('BUILDINGCLASS_FW_ORBITAL_REFINERY',	'BUILDING_FW_ORBITAL_REFINERY',			'TXT_KEY_BUILDING_FW_ORBITAL_REFINERY'),
	('BUILDINGCLASS_FW_TERRAFORMING_STATION','BUILDING_FW_TERRAFORMING_STATION',	'TXT_KEY_BUILDING_FW_TERRAFORMING_STATION'),
	('BUILDINGCLASS_FW_PHOTOSYSTEMS',		'BUILDING_FW_PHOTOSYSTEMS',				'TXT_KEY_BUILDING_FW_PHOTOSYSTEMS'),
	('BUILDINGCLASS_FW_BIRTHING_PODS',		'BUILDING_FW_BIRTHING_PODS',			'TXT_KEY_BUILDING_FW_BIRTHING_PODS'),
	('BUILDINGCLASS_FW_BRAIN_UPLOADING',		'BUILDING_FW_BRAIN_UPLOADING',			'TXT_KEY_BUILDING_FW_BRAIN_UPLOADING'),
	('BUILDINGCLASS_FW_AI_NETWORK',			'BUILDING_FW_AI_NETWORK',				'TXT_KEY_BUILDING_FW_AI_NETWORK'),
	('BUILDINGCLASS_FW_ALLOY_FOUNDRY',		'BUILDING_FW_ALLOY_FOUNDRY',			'TXT_KEY_BUILDING_FW_ALLOY_FOUNDRY'),
	('BUILDINGCLASS_FW_UTILITY_FOG',			'BUILDING_FW_UTILITY_FOG',				'TXT_KEY_BUILDING_FW_UTILITY_FOG'),
	('BUILDINGCLASS_FW_MOON_BASE',			'BUILDING_FW_MOON_BASE',				'TXT_KEY_BUILDING_FW_MOON_BASE'),
	('BUILDINGCLASS_FW_CENTRAL_COMMAND',		'BUILDING_FW_CENTRAL_COMMAND',			'TXT_KEY_BUILDING_FW_CENTRAL_COMMAND'),
	('BUILDINGCLASS_FW_GENOME_PROJECT_1',	'BUILDING_FW_GENOME_PROJECT_1',			'TXT_KEY_BUILDING_FW_GENOME_PROJECT_1'),
	('BUILDINGCLASS_FW_GENOME_PROJECT_2',	'BUILDING_FW_GENOME_PROJECT_2',			'TXT_KEY_BUILDING_FW_GENOME_PROJECT_2');

INSERT INTO Buildings
	(Type, 									BuildingClass, 								PrereqTech, 			Cost, ArtDefineTag, 						PortraitIndex, 	IconAtlas, 					Description, Civilopedia, Strategy, Help, MinAreaSize, HurryCostModifier, ConquestProb)
VALUES
	('BUILDING_FW_SERVER_HUB', 				'BUILDINGCLASS_FW_SERVER_HUB',				'TECH_INTERNET', 		2750, 'ART_DEF_BUILDING_LABORATORY',        32,				'CIV_COLOR_ATLAS_FW_2', 	'TXT_KEY_BUILDING_FW_SERVER_HUB', 				'TXT_KEY_BUILDING_FW_SERVER_HUB_PEDIA', 				'TXT_KEY_BUILDING_FW_SERVER_HUB_STRATEGY', 				'TXT_KEY_BUILDING_FW_SERVER_HUB_HELP', 							-1, -20, 80),
	('BUILDING_FW_ENTERTAINMENT_SERVER', 	'BUILDINGCLASS_FW_ENTERTAINMENT_SERVER', 	'TECH_GEN_MANIP', 		4250, 'ART_DEF_BUILDING_LABORATORY',        42,				'CIV_COLOR_ATLAS_FW_2', 	'TXT_KEY_BUILDING_FW_ENTERTAINMENT_SERVER', 	'TXT_KEY_BUILDING_FW_ENTERTAINMENT_SERVER_PEDIA', 		'TXT_KEY_BUILDING_FW_ENTERTAINMENT_SERVER_STRATEGY', 	'TXT_KEY_BUILDING_FW_ENTERTAINMENT_SERVER_HELP', 				-1, -20, 80),
	('BUILDING_FW_COMMERCE_SERVER', 		'BUILDINGCLASS_FW_COMMERCE_SERVER',			'TECH_SUPERCOMPUTERS', 	4250, 'ART_DEF_BUILDING_LABORATORY',    33,				'CIV_COLOR_ATLAS_FW_2', 	'TXT_KEY_BUILDING_FW_COMMERCE_SERVER', 		'TXT_KEY_BUILDING_FW_COMMERCE_SERVER_PEDIA', 		'TXT_KEY_BUILDING_FW_COMMERCE_SERVER_STRATEGY', 		'TXT_KEY_BUILDING_FW_COMMERCE_SERVER_HELP', 								-1, -20, 80),
	('BUILDING_FW_CLOUD_COMPUTING', 		'BUILDINGCLASS_FW_CLOUD_COMPUTING',			'TECH_ROBOTICS', 				    4250, 'ART_DEF_BUILDING_LABORATORY',        44,	'CIV_COLOR_ATLAS_FW_2', 						'TXT_KEY_BUILDING_FW_CLOUD_COMPUTING', 		'TXT_KEY_BUILDING_FW_CLOUD_COMPUTING_PEDIA', 		'TXT_KEY_BUILDING_FW_CLOUD_COMPUTING_STRATEGY', 		'TXT_KEY_BUILDING_FW_CLOUD_COMPUTING_HELP', 		-1, -20, 80),
	('BUILDING_FW_RESEARCH_SERVER', 		'BUILDINGCLASS_FW_RESEARCH_SERVER',			'TECH_NANOMATERIALS', 			    4250, 'ART_DEF_BUILDING_LABORATORY',        34,	'CIV_COLOR_ATLAS_FW_2', 				 		'TXT_KEY_BUILDING_FW_RESEARCH_SERVER', 		'TXT_KEY_BUILDING_FW_RESEARCH_SERVER_PEDIA', 		'TXT_KEY_BUILDING_FW_RESEARCH_SERVER_STRATEGY', 		'TXT_KEY_BUILDING_FW_RESEARCH_SERVER_HELP', 		-1, -20, 80),
	('BUILDING_FW_GENE_LAB', 				'BUILDINGCLASS_FW_GENE_LAB',				'TECH_GEN_MANIP', 					4250, 'ART_DEF_BUILDING_LABORATORY',        20,	'CIV_COLOR_ATLAS_FW_2', 								'TXT_KEY_BUILDING_FW_GENE_LAB', 				'TXT_KEY_BUILDING_FW_GENE_LAB_PEDIA', 				'TXT_KEY_BUILDING_FW_GENE_LAB_STRATEGY', 				'TXT_KEY_BUILDING_FW_GENE_LAB_HELP', 				-1, -20, 80),
	('BUILDING_FW_CYBERPOLICE', 			'BUILDINGCLASS_FW_CYBERPOLICE',				'TECH_SUPERCOMPUTERS', 				4250, 'ART_DEF_BUILDING_COLOSSEUM',         11,	'EXPANSION_BW_ATLAS_1', 				 			'TXT_KEY_BUILDING_FW_CYBERPOLICE', 			'TXT_KEY_BUILDING_FW_CYBERPOLICE_PEDIA', 			'TXT_KEY_BUILDING_FW_CYBERPOLICE_STRATEGY', 			'TXT_KEY_BUILDING_FW_CYBERPOLICE_HELP', 			-1, -20, 80),
	('BUILDING_FW_NANOMAT_PLANT', 			'BUILDINGCLASS_FW_NANOMAT_PLANT', 		'TECH_NANOMATERIALS', 				4250, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     3,	'CIV_COLOR_ATLAS_FW', 				'TXT_KEY_BUILDING_FW_NANOMAT_PLANT', 			'TXT_KEY_BUILDING_FW_NANOMAT_PLANT_PEDIA', 			'TXT_KEY_BUILDING_FW_NANOMAT_PLANT_STRATEGY', 		'TXT_KEY_BUILDING_FW_NANOMAT_PLANT_HELP', 			-1, -20, 80),
	('BUILDING_FW_AQUACULTURE_LAB', 		'BUILDINGCLASS_FW_AQUACULTURE_LAB', 		'TECH_EUTHENICS', 					5000, 'ART_DEF_BUILDING_LABORATORY',        51,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_AQUACULTURE_LAB', 		'TXT_KEY_BUILDING_FW_AQUACULTURE_LAB_PEDIA', 		'TXT_KEY_BUILDING_FW_AQUACULTURE_LAB_STRATEGY', 		'TXT_KEY_BUILDING_FW_AQUACULTURE_LAB_HELP', 		-1, -20, 80),
	('BUILDING_FW_FUNGAL_AGRIGENOMICS', 	'BUILDINGCLASS_FW_FUNGAL_AGRIGENOMICS', 	'TECH_EUTHENICS', 					5000, 'ART_DEF_BUILDING_LABORATORY',        43,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_FUNGAL_AGRIGENOMICS', 	'TXT_KEY_BUILDING_FW_FUNGAL_AGRIGENOMICS_PEDIA', 	'TXT_KEY_BUILDING_FW_FUNGAL_AGRIGENOMICS_STRATEGY', 	'TXT_KEY_BUILDING_FW_FUNGAL_AGRIGENOMICS_HELP', 	-1, -20, 80),
	('BUILDING_FW_CRYPTOBANK', 				'BUILDINGCLASS_FW_CRYPTOBANK', 			'TECH_GRID_COMPUTING', 				5000, 'ART_DEF_BUILDING_STOCK_EXCHANGE',    15,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_CRYPTOBANK', 				'TXT_KEY_BUILDING_FW_CRYPTOBANK_PEDIA', 				'TXT_KEY_BUILDING_FW_CRYPTOBANK_STRATEGY', 			'TXT_KEY_BUILDING_FW_CRYPTOBANK_HELP', 				-1, -20, 80),
	('BUILDING_FW_UNDERSEA_MINING', 		'BUILDINGCLASS_FW_UNDERSEA_MINING', 		'TECH_GRID_COMPUTING', 	        	5000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    53,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_UNDERSEA_MINING', 		'TXT_KEY_BUILDING_FW_UNDERSEA_MINING_PEDIA', 		'TXT_KEY_BUILDING_FW_UNDERSEA_MINING_STRATEGY', 		'TXT_KEY_BUILDING_FW_UNDERSEA_MINING_HELP', 		-1, -20, 80),
	('BUILDING_FW_AUTOPLANT', 				'BUILDINGCLASS_FW_AUTOPLANT', 			'TECH_POWER_SYSTEMS', 		        5000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    12,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_AUTOPLANT', 				'TXT_KEY_BUILDING_FW_AUTOPLANT_PEDIA', 				'TXT_KEY_BUILDING_FW_AUTOPLANT_STRATEGY', 			'TXT_KEY_BUILDING_FW_AUTOPLANT_HELP', 				-1, -20, 80),
	('BUILDING_FW_VR_TRAINING', 			'BUILDINGCLASS_FW_VR_TRAINING', 		'TECH_MEMETICS', 					5000, 'ART_DEF_BUILDING_LABORATORY',         0,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_VR_TRAINING', 			'TXT_KEY_BUILDING_FW_VR_TRAINING_PEDIA', 			'TXT_KEY_BUILDING_FW_VR_TRAINING_STRATEGY', 		'TXT_KEY_BUILDING_FW_VR_TRAINING_HELP', 			-1, -20, 80),
	('BUILDING_FW_VIRTUAL_MUSEUM', 			'BUILDINGCLASS_FW_VIRTUAL_MUSEUM', 		'TECH_MEMETICS', 					5000, 'ART_DEF_BUILDING_MUSEUM',            39,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_VIRTUAL_MUSEUM', 			'TXT_KEY_BUILDING_FW_VIRTUAL_MUSEUM_PEDIA', 		'TXT_KEY_BUILDING_FW_VIRTUAL_MUSEUM_STRATEGY', 		'TXT_KEY_BUILDING_FW_VIRTUAL_MUSEUM_HELP', 		-1, -20, 80),
	('BUILDING_FW_NANOFORGE', 				'BUILDINGCLASS_FW_NANOFORGE', 			'TECH_NANOTECHNOLOGY', 				5250, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',      8,'TCS_MOD_ICON_ATLAS', 				'TXT_KEY_BUILDING_FW_NANOFORGE', 				'TXT_KEY_BUILDING_FW_NANOFORGE_PEDIA', 				'TXT_KEY_BUILDING_FW_NANOFORGE_STRATEGY', 			'TXT_KEY_BUILDING_FW_NANOFORGE_HELP', 				-1, -20, 80),
	('BUILDING_FW_PARTICLE_ACCELERATOR', 	'BUILDINGCLASS_FW_PARTICLE_ACCELERATOR', 'TECH_PARTICLE_PHYSICS', 			5000, 'ART_DEF_BUILDING_LABORATORY',         0,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_PARTICLE_ACCELERATOR', 	'TXT_KEY_BUILDING_FW_PARTICLE_ACCELERATOR_PEDIA', 	'TXT_KEY_BUILDING_FW_PARTICLE_ACCELERATOR_STRATEGY', 	'TXT_KEY_BUILDING_FW_PARTICLE_ACCELERATOR_HELP', 	-1, -20, 80),
	('BUILDING_FW_VERTICAL_FARM', 			'BUILDINGCLASS_FW_VERTICAL_FARM', 		'TECH_ARTIFICIAL_ENVIRONMENTS', 	5000, 'ART_DEF_BUILDING_LABORATORY',         7,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_VERTICAL_FARM', 			'TXT_KEY_BUILDING_FW_VERTICAL_FARM_PEDIA', 		'TXT_KEY_BUILDING_FW_VERTICAL_FARM_STRATEGY', 		'TXT_KEY_BUILDING_FW_VERTICAL_FARM_HELP', 		-1, -20, 80),
	('BUILDING_FW_SEAWATER_ARTIFICIAL_REEF','BUILDINGCLASS_FW_SEAWATER_ARTIFICIAL_REEF','TECH_ARTIFICIAL_ENVIRONMENTS', 	5000, 'ART_DEF_FEATURE_REEF',                1,	'NW_ATLAS', 				'TXT_KEY_BUILDING_FW_SEAWATER_ARTIFICIAL_REEF', 'TXT_KEY_BUILDING_FW_SEAWATER_ARTIFICIAL_REEF_PEDIA', 'TXT_KEY_BUILDING_FW_SEAWATER_ARTIFICIAL_REEF_STRATEGY', 'TXT_KEY_BUILDING_FW_SEAWATER_ARTIFICIAL_REEF_HELP', -1, -20, 80),
	('BUILDING_FW_ECOSANCTUARY', 			'BUILDINGCLASS_FW_ECOSANCTUARY', 		'TECH_FW_ECOTHEORY', 	            5750, 'ART_DEF_BUILDING_FW_GARDEN',         31,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_ECOSANCTUARY', 			'TXT_KEY_BUILDING_FW_ECOSANCTUARY_PEDIA', 		'TXT_KEY_BUILDING_FW_ECOSANCTUARY_STRATEGY', 		'TXT_KEY_BUILDING_FW_ECOSANCTUARY_HELP', 		-1, -20, 80),
	('BUILDING_FW_BIOFACTORY', 				'BUILDINGCLASS_FW_BIOFACTORY', 			'TECH_FW_ECOTHEORY', 				5750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     2,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_BIOFACTORY', 				'TXT_KEY_BUILDING_FW_BIOFACTORY_PEDIA', 			'TXT_KEY_BUILDING_FW_BIOFACTORY_STRATEGY', 		'TXT_KEY_BUILDING_FW_BIOFACTORY_HELP', 			-1, -20, 80),
	('BUILDING_FW_IMPLANT_CLINIC', 			'BUILDINGCLASS_FW_IMPLANT_CLINIC', 		'TECH_IMPLANTS', 					4750, 'ART_DEF_BUILDING_LABORATORY',         4,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_IMPLANT_CLINIC', 			'TXT_KEY_BUILDING_FW_IMPLANT_CLINIC_PEDIA', 		'TXT_KEY_BUILDING_FW_IMPLANT_CLINIC_STRATEGY', 		'TXT_KEY_BUILDING_FW_IMPLANT_CLINIC_HELP', 		-1, -20, 80),
	('BUILDING_FW_TELEPRESENCE_HUB', 		'BUILDINGCLASS_FW_TELEPRESENCE_HUB', 	'TECH_IMPLANTS',	 		    	4750, 'ART_DEF_BUILDING_LABORATORY',        61,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_TELEPRESENCE_HUB', 		'TXT_KEY_BUILDING_FW_TELEPRESENCE_HUB_PEDIA', 	'TXT_KEY_BUILDING_FW_TELEPRESENCE_HUB_STRATEGY', 	'TXT_KEY_BUILDING_FW_TELEPRESENCE_HUB_HELP', 		-1, -20, 80),
	('BUILDING_FW_NETWORK_BACKBONE', 		'BUILDINGCLASS_FW_NETWORK_BACKBONE', 	'TECH_COGNITIVE_TECH', 				5750, 'ART_DEF_BUILDING_LABORATORY',         1,	'CIV_COLOR_ATLAS_FW', 				'TXT_KEY_BUILDING_FW_NETWORK_BACKBONE', 		'TXT_KEY_BUILDING_FW_NETWORK_BACKBONE_PEDIA', 	'TXT_KEY_BUILDING_FW_NETWORK_BACKBONE_STRATEGY', 	'TXT_KEY_BUILDING_FW_NETWORK_BACKBONE_HELP', 		-1, -20, 80),
	('BUILDING_FW_BOREHOLE', 				'BUILDINGCLASS_FW_BOREHOLE', 			'TECH_QUANTUM_COMPUTERS',           5750, 'ART_DEF_BUILDING_LABORATORY',        36,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_BOREHOLE', 				'TXT_KEY_BUILDING_FW_BOREHOLE_PEDIA', 				'TXT_KEY_BUILDING_FW_BOREHOLE_STRATEGY', 			'TXT_KEY_BUILDING_FW_BOREHOLE_HELP', 				-1, -20, 80),
	('BUILDING_FW_GEOTHERMAL_FACTORY', 		'BUILDINGCLASS_FW_GEOTHERMAL_FACTORY', 	'TECH_QUANTUM_COMPUTERS', 			5750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    48,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_GEOTHERMAL_FACTORY', 		'TXT_KEY_BUILDING_FW_GEOTHERMAL_FACTORY_PEDIA', 	'TXT_KEY_BUILDING_FW_GEOTHERMAL_FACTORY_STRATEGY', 	'TXT_KEY_BUILDING_FW_GEOTHERMAL_FACTORY_HELP', 	-1, -20, 80),
	('BUILDING_FW_HYDROTHERMAL_FACTORY', 	'BUILDINGCLASS_FW_HYDROTHERMAL_FACTORY','TECH_QUANTUM_COMPUTERS', 			5750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',  	46,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_HYDROTHERMAL_FACTORY', 	'TXT_KEY_BUILDING_FW_HYDROTHERMAL_FACTORY_PEDIA', 	'TXT_KEY_BUILDING_FW_HYDROTHERMAL_FACTORY_STRATEGY', 'TXT_KEY_BUILDING_FW_HYDROTHERMAL_FACTORY_HELP', 	-1, -20, 80),
	('BUILDING_FW_LAUNCH_FACILITY', 		'BUILDINGCLASS_FW_LAUNCH_FACILITY', 	'TECH_ORBITAL_DEV', 			    5750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    56,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_LAUNCH_FACILITY', 		'TXT_KEY_BUILDING_FW_LAUNCH_FACILITY_PEDIA', 	'TXT_KEY_BUILDING_FW_LAUNCH_FACILITY_STRATEGY', 	'TXT_KEY_BUILDING_FW_LAUNCH_FACILITY_HELP', 		-1, -20, 80),
	('BUILDING_FW_CLONE_LAB', 				'BUILDINGCLASS_FW_CLONE_LAB', 			'TECH_CLONING', 					6500, 'ART_DEF_BUILDING_LABORATORY',        5, 	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_CLONE_LAB', 				'TXT_KEY_BUILDING_FW_CLONE_LAB_PEDIA', 				'TXT_KEY_BUILDING_FW_CLONE_LAB_STRATEGY', 		'TXT_KEY_BUILDING_FW_CLONE_LAB_HELP', 				-1, -20, 80),
	('BUILDING_FW_BIOFLESH_INDUSTRY', 		'BUILDINGCLASS_FW_BIOFLESH_INDUSTRY', 	'TECH_CLONING', 					6500, 'ART_DEF_BUILDING_LABORATORY',        21,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_BIOFLESH_INDUSTRY', 		'TXT_KEY_BUILDING_FW_BIOFLESH_INDUSTRY_PEDIA', 	'TXT_KEY_BUILDING_FW_BIOFLESH_INDUSTRY_STRATEGY', 	'TXT_KEY_BUILDING_FW_BIOFLESH_INDUSTRY_HELP', 	-1, -20, 80),
	('BUILDING_FW_GENEJACK_FACILITY', 		'BUILDINGCLASS_FW_GENEJACK_FACILITY', 	'TECH_ORGANICS', 		        	6500, 'ART_DEF_BUILDING_LABORATORY',        29,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_GENEJACK_FACILITY', 		'TXT_KEY_BUILDING_FW_GENEJACK_FACILITY_PEDIA', 	'TXT_KEY_BUILDING_FW_GENEJACK_FACILITY_STRATEGY', 	'TXT_KEY_BUILDING_FW_GENEJACK_FACILITY_HELP', 	-1, -20, 80),
	('BUILDING_FW_CONVERTER', 				'BUILDINGCLASS_FW_CONVERTER', 			'TECH_POWER_SYSTEMS', 		        4000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    2,	'CIV_COLOR_ATLAS_FW', 				'TXT_KEY_BUILDING_FW_CONVERTER', 				'TXT_KEY_BUILDING_FW_CONVERTER_PEDIA', 				'TXT_KEY_BUILDING_FW_CONVERTER_STRATEGY', 		'TXT_KEY_BUILDING_FW_CONVERTER_HELP', 				-1, -20, 80),
	('BUILDING_FW_CONVERTER_OIL', 			'BUILDINGCLASS_FW_CONVERTER_OIL', 		'TECH_POWER_SYSTEMS', 		        4500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    2,	'CIV_COLOR_ATLAS_FW', 				'TXT_KEY_BUILDING_FW_CONVERTER_OIL', 			'TXT_KEY_BUILDING_FW_CONVERTER_OIL_PEDIA', 		'TXT_KEY_BUILDING_FW_CONVERTER_OIL_STRATEGY', 	'TXT_KEY_BUILDING_FW_CONVERTER_OIL_HELP', 		-1, -20, 80),
	('BUILDING_FW_CONVERTER_IRON', 			'BUILDINGCLASS_FW_CONVERTER_IRON', 		'TECH_POWER_SYSTEMS', 		        4500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    2,	'CIV_COLOR_ATLAS_FW', 				'TXT_KEY_BUILDING_FW_CONVERTER_IRON', 			'TXT_KEY_BUILDING_FW_CONVERTER_IRON_PEDIA', 		'TXT_KEY_BUILDING_FW_CONVERTER_IRON_STRATEGY', 	'TXT_KEY_BUILDING_FW_CONVERTER_IRON_HELP', 		-1, -20, 80),
	('BUILDING_FW_METROPLEX_HUB', 			'BUILDINGCLASS_FW_METROPLEX_HUB', 		'TECH_ORGANICS', 			        6500, 'ART_DEF_BUILDING_LABORATORY',        28,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_METROPLEX_HUB', 			'TXT_KEY_BUILDING_FW_METROPLEX_HUB_PEDIA', 		'TXT_KEY_BUILDING_FW_METROPLEX_HUB_STRATEGY', 		'TXT_KEY_BUILDING_FW_METROPLEX_HUB_HELP', 		-1, -20, 80),
	('BUILDING_FW_FEEDSITE_HUB', 			'BUILDINGCLASS_FW_FEEDSITE_HUB', 		'TECH_ORGANICS', 		            6500, 'ART_DEF_BUILDING_LABORATORY',        40,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_FEEDSITE_HUB', 			'TXT_KEY_BUILDING_FW_FEEDSITE_HUB_PEDIA', 		'TXT_KEY_BUILDING_FW_FEEDSITE_HUB_STRATEGY', 		'TXT_KEY_BUILDING_FW_FEEDSITE_HUB_HELP', 		-1, -20, 80),
	('BUILDING_FW_DISTRIBUTION_HUB', 		'BUILDINGCLASS_FW_DISTRIBUTION_HUB', 	'TECH_NUCLEAR_ENRICHMENT', 		    6500, 'ART_DEF_BUILDING_LABORATORY',        61,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_DISTRIBUTION_HUB', 		'TXT_KEY_BUILDING_FW_DISTRIBUTION_HUB_PEDIA', 	'TXT_KEY_BUILDING_FW_DISTRIBUTION_HUB_STRATEGY', 	'TXT_KEY_BUILDING_FW_DISTRIBUTION_HUB_HELP', 	-1, -20, 80),
	('BUILDING_FW_SIMULATION_HUB', 			'BUILDINGCLASS_FW_SIMULATION_HUB', 		'TECH_NUCLEAR_ENRICHMENT', 		    6500, 'ART_DEF_BUILDING_LABORATORY',         6,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_SIMULATION_HUB', 			'TXT_KEY_BUILDING_FW_SIMULATION_HUB_PEDIA', 	'TXT_KEY_BUILDING_FW_SIMULATION_HUB_STRATEGY', 	'TXT_KEY_BUILDING_FW_SIMULATION_HUB_HELP', 		-1, -20, 80),
	('BUILDING_FW_ENRICHMENT_FACILITY', 	'BUILDINGCLASS_FW_ENRICHMENT_FACILITY', 'TECH_NUCLEAR_ENRICHMENT', 			6750, 'ART_DEF_BUILDING_LABORATORY',        40,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_ENRICHMENT_FACILITY', 	'TXT_KEY_BUILDING_FW_ENRICHMENT_FACILITY_PEDIA', 	'TXT_KEY_BUILDING_FW_ENRICHMENT_FACILITY_STRATEGY', 'TXT_KEY_BUILDING_FW_ENRICHMENT_FACILITY_HELP', 	-1, -20, 80),
	('BUILDING_FW_SPACE_STATION', 			'BUILDINGCLASS_FW_SPACE_STATION', 		'TECH_ASTRODYNAMICS', 				6500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    52,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_SPACE_STATION', 			'TXT_KEY_BUILDING_FW_SPACE_STATION_PEDIA', 		'TXT_KEY_BUILDING_FW_SPACE_STATION_STRATEGY', 	'TXT_KEY_BUILDING_FW_SPACE_STATION_HELP', 		-1, -20, 80),
	('BUILDING_FW_MYCOPROTEIN_VATS', 		'BUILDINGCLASS_FW_MYCOPROTEIN_VATS', 	'TECH_ASTRODYNAMICS', 		    	6500, 'ART_DEF_BUILDING_LABORATORY',        60,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_MYCOPROTEIN_VATS', 		'TXT_KEY_BUILDING_FW_MYCOPROTEIN_VATS_PEDIA', 	'TXT_KEY_BUILDING_FW_MYCOPROTEIN_VATS_STRATEGY', 	'TXT_KEY_BUILDING_FW_MYCOPROTEIN_VATS_HELP', 	-1, -20, 80),
	('BUILDING_FW_RESEARCH_MODULE', 		'BUILDINGCLASS_FW_RESEARCH_MODULE', 	'TECH_ASTRODYNAMICS', 		    	7000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    24,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_RESEARCH_MODULE', 		'TXT_KEY_BUILDING_FW_RESEARCH_MODULE_PEDIA', 	'TXT_KEY_BUILDING_FW_RESEARCH_MODULE_STRATEGY', 	'TXT_KEY_BUILDING_FW_RESEARCH_MODULE_HELP', 		-1, -20, 80),
	('BUILDING_FW_ENGINEERING_MODULE', 		'BUILDINGCLASS_FW_ENGINEERING_MODULE', 'TECH_ASTRODYNAMICS', 		    	7000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    25,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_ENGINEERING_MODULE', 		'TXT_KEY_BUILDING_FW_ENGINEERING_MODULE_PEDIA', 	'TXT_KEY_BUILDING_FW_ENGINEERING_MODULE_STRATEGY', 'TXT_KEY_BUILDING_FW_ENGINEERING_MODULE_HELP', 	-1, -20, 80),
	('BUILDING_FW_COMM_MODULE', 			'BUILDINGCLASS_FW_COMM_MODULE', 		'TECH_ASTRODYNAMICS', 		   	 	7000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    28,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_COMM_MODULE', 			'TXT_KEY_BUILDING_FW_COMM_MODULE_PEDIA', 		'TXT_KEY_BUILDING_FW_COMM_MODULE_STRATEGY', 	'TXT_KEY_BUILDING_FW_COMM_MODULE_HELP', 		-1, -20, 80),
	('BUILDING_FW_TIDAL_PORT', 				'BUILDINGCLASS_FW_TIDAL_PORT', 			'TECH_NEURAL_INTERFACE', 		    7250, 'ART_DEF_BUILDING_FW_HYDRO_ARRAY',    57,	'TCS_MOD_ICON_ATLAS', 				'TXT_KEY_BUILDING_FW_TIDAL_PORT', 				'TXT_KEY_BUILDING_FW_TIDAL_PORT_PEDIA', 			'TXT_KEY_BUILDING_FW_TIDAL_PORT_STRATEGY', 		'TXT_KEY_BUILDING_FW_TIDAL_PORT_HELP', 			-1, -20, 80),
	('BUILDING_FW_CYBERCLINIC', 			'BUILDINGCLASS_FW_CYBERCLINIC', 		'TECH_NEURAL_INTERFACE', 			7250, 'ART_DEF_BUILDING_LABORATORY',         8,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_CYBERCLINIC', 			'TXT_KEY_BUILDING_FW_CYBERCLINIC_PEDIA', 		'TXT_KEY_BUILDING_FW_CYBERCLINIC_STRATEGY', 		'TXT_KEY_BUILDING_FW_CYBERCLINIC_HELP', 		-1, -20, 80),
	('BUILDING_FW_HIGHSPEED_RAIL', 			'BUILDINGCLASS_FW_HIGHSPEED_RAIL', 		'TECH_SUPERCONDUCTIVITY', 			7250, 'ART_DEF_BUILDING_GARDEN',             2,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_HIGHSPEED_RAIL', 			'TXT_KEY_BUILDING_FW_HIGHSPEED_RAIL_PEDIA', 	'TXT_KEY_BUILDING_FW_HIGHSPEED_RAIL_STRATEGY', 	'TXT_KEY_BUILDING_FW_HIGHSPEED_RAIL_HELP', 		-1, -20, 80),
	('BUILDING_FW_AEROSPACE_COMPLEX', 		'BUILDINGCLASS_FW_AEROSPACE_COMPLEX', 	'TECH_SUPERCONDUCTIVITY', 		   	7250, 'ART_DEF_BUILDING_AIRPORT',           30,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_AEROSPACE_COMPLEX', 		'TXT_KEY_BUILDING_FW_AEROSPACE_COMPLEX_PEDIA', 	'TXT_KEY_BUILDING_FW_AEROSPACE_COMPLEX_STRATEGY', 'TXT_KEY_BUILDING_FW_AEROSPACE_COMPLEX_HELP', 	-1, -20, 80),
	('BUILDING_FW_TRANSGENIC_NURSERY', 		'BUILDINGCLASS_FW_TRANSGENIC_NURSERY', 'TECH_TRANSGENICS', 				7250, 'ART_DEF_BUILDING_LABORATORY',        59,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_TRANSGENIC_NURSERY', 		'TXT_KEY_BUILDING_FW_TRANSGENIC_NURSERY_PEDIA', 	'TXT_KEY_BUILDING_FW_TRANSGENIC_NURSERY_STRATEGY', 'TXT_KEY_BUILDING_FW_TRANSGENIC_NURSERY_HELP', 	-1, -20, 80),
	('BUILDING_FW_DRONE_HIVE', 				'BUILDINGCLASS_FW_DRONE_HIVE', 			'TECH_AUTONOMOUS_SYSTEMS', 			7250, 'ART_DEF_BUILDING_LABORATORY',         9,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_DRONE_HIVE', 				'TXT_KEY_BUILDING_FW_DRONE_HIVE_PEDIA', 			'TXT_KEY_BUILDING_FW_DRONE_HIVE_STRATEGY', 		'TXT_KEY_BUILDING_FW_DRONE_HIVE_HELP', 			-1, -20, 80),
	('BUILDING_FW_NANOMINES_FIELD', 		'BUILDINGCLASS_FW_NANOMINES_FIELD',		'TECH_ARCOLOGIES', 			        7250, 'ART_DEF_BUILDING_GARDEN',            18,	'TCS_MOD_ICON_ATLAS', 					'TXT_KEY_BUILDING_FW_NANOMINES_FIELD', 		'TXT_KEY_BUILDING_FW_NANOMINES_FIELD_PEDIA', 	'TXT_KEY_BUILDING_FW_NANOMINES_FIELD_STRATEGY', 	'TXT_KEY_BUILDING_FW_NANOMINES_FIELD_HELP', 		-1, -20, 80),
	('BUILDING_FW_DEFENSE_FIELD', 			'BUILDINGCLASS_FW_DEFENSE_FIELD', 		'TECH_ARCOLOGIES', 			        7250, 'ART_DEF_BUILDING_FW_MILITARY_BASE',  33,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_DEFENSE_FIELD', 			'TXT_KEY_BUILDING_FW_DEFENSE_FIELD_PEDIA', 		'TXT_KEY_BUILDING_FW_DEFENSE_FIELD_STRATEGY', 	'TXT_KEY_BUILDING_FW_DEFENSE_FIELD_HELP', 		-1, -20, 80),
	('BUILDING_FW_ECTOGENESIS_POD', 		'BUILDINGCLASS_FW_ECTOGENESIS_POD', 	'TECH_GENGINEERING', 				7750, 'ART_DEF_BUILDING_LABORATORY',        22,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_ECTOGENESIS_POD', 		'TXT_KEY_BUILDING_FW_ECTOGENESIS_POD_PEDIA', 	'TXT_KEY_BUILDING_FW_ECTOGENESIS_POD_STRATEGY', 	'TXT_KEY_BUILDING_FW_ECTOGENESIS_POD_HELP', 	-1, -20, 80),
	('BUILDING_FW_MASS_DIGESTER', 			'BUILDINGCLASS_FW_MASS_DIGESTER', 		'TECH_BIOMODIFICATION', 	    	7750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     4,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_MASS_DIGESTER', 			'TXT_KEY_BUILDING_FW_MASS_DIGESTER_PEDIA', 		'TXT_KEY_BUILDING_FW_MASS_DIGESTER_STRATEGY', 	'TXT_KEY_BUILDING_FW_MASS_DIGESTER_HELP', 		-1, -20, 80),
	('BUILDING_FW_BIOMOD_TANK', 			'BUILDINGCLASS_FW_BIOMOD_TANK', 		'TECH_BIOMODIFICATION', 			7750, 'ART_DEF_BUILDING_LABORATORY',        30,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_BIOMOD_TANK', 			'TXT_KEY_BUILDING_FW_BIOMOD_TANK_PEDIA', 		'TXT_KEY_BUILDING_FW_BIOMOD_TANK_STRATEGY', 	'TXT_KEY_BUILDING_FW_BIOMOD_TANK_HELP', 		-1, -20, 80),
	('BUILDING_FW_DIGITAL_POLICE', 			'BUILDINGCLASS_FW_DIGITAL_POLICE', 		'TECH_AI', 		                	7750, 'ART_DEF_BUILDING_COLOSSEUM',         11,	'EXPANSION_BW_ATLAS_1', 				'TXT_KEY_BUILDING_FW_DIGITAL_POLICE', 			'TXT_KEY_BUILDING_FW_DIGITAL_POLICE_PEDIA', 		'TXT_KEY_BUILDING_FW_DIGITAL_POLICE_STRATEGY', 	'TXT_KEY_BUILDING_FW_DIGITAL_POLICE_HELP', 		-1, -20, 80),
	('BUILDING_FW_FUSION_PLANT', 			'BUILDINGCLASS_FW_FUSION_PLANT', 		'TECH_NUCLEAR_FUSION', 				7750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     6,	'CIV_COLOR_ATLAS_FW', 				'TXT_KEY_BUILDING_FW_FUSION_PLANT', 			'TXT_KEY_BUILDING_FW_FUSION_PLANT_PEDIA', 		'TXT_KEY_BUILDING_FW_FUSION_PLANT_STRATEGY', 	'TXT_KEY_BUILDING_FW_FUSION_PLANT_HELP', 		-1, -20, 80),
	('BUILDING_FW_ORBITAL_HABITAT', 		'BUILDINGCLASS_FW_ORBITAL_HABITAT', 	'TECH_ADAMANTIUM', 	                8250, 'ART_DEF_BUILDING_HOSPITAL',          26,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_ORBITAL_HABITAT', 		'TXT_KEY_BUILDING_FW_ORBITAL_HABITAT_PEDIA', 	'TXT_KEY_BUILDING_FW_ORBITAL_HABITAT_STRATEGY', 	'TXT_KEY_BUILDING_FW_ORBITAL_HABITAT_HELP', 	-1, -20, 80),
	('BUILDING_FW_ORBITAL_REFINERY', 		'BUILDINGCLASS_FW_ORBITAL_REFINERY', 	'TECH_ADAMANTIUM', 					9000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    57,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_ORBITAL_REFINERY', 		'TXT_KEY_BUILDING_FW_ORBITAL_REFINERY_PEDIA', 	'TXT_KEY_BUILDING_FW_ORBITAL_REFINERY_STRATEGY', 'TXT_KEY_BUILDING_FW_ORBITAL_REFINERY_HELP', 	-1, -20, 80),
	('BUILDING_FW_TERRAFORMING_STATION', 	'BUILDINGCLASS_FW_TERRAFORMING_STATION','TECH_TERRAFORMING', 				8250, 'ART_DEF_BUILDING_LABORATORY',        36,	'CIV_COLOR_ATLAS_FW', 				'TXT_KEY_BUILDING_FW_TERRAFORMING_STATION', 	'TXT_KEY_BUILDING_FW_TERRAFORMING_STATION_PEDIA', 	'TXT_KEY_BUILDING_FW_TERRAFORMING_STATION_STRATEGY', 'TXT_KEY_BUILDING_FW_TERRAFORMING_STATION_HELP', 	-1, -20, 80),
	('BUILDING_FW_PHOTOSYSTEMS', 			'BUILDINGCLASS_FW_PHOTOSYSTEMS', 		'TECH_TERRAFORMING', 				8250, 'ART_DEF_BUILDING_LABORATORY',        35,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_PHOTOSYSTEMS', 			'TXT_KEY_BUILDING_FW_PHOTOSYSTEMS_PEDIA', 		'TXT_KEY_BUILDING_FW_PHOTOSYSTEMS_STRATEGY', 	'TXT_KEY_BUILDING_FW_PHOTOSYSTEMS_HELP', 		-1, -20, 80),
	('BUILDING_FW_BIRTHING_PODS', 			'BUILDINGCLASS_FW_BIRTHING_PODS', 		'TECH_HUMAN_AUGMENTATION', 			8250, 'ART_DEF_BUILDING_LABORATORY',        62,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_BIRTHING_PODS', 			'TXT_KEY_BUILDING_FW_BIRTHING_PODS_PEDIA', 		'TXT_KEY_BUILDING_FW_BIRTHING_PODS_STRATEGY', 	'TXT_KEY_BUILDING_FW_BIRTHING_PODS_HELP', 		-1, -20, 80),
	('BUILDING_FW_BRAIN_UPLOADING', 		'BUILDINGCLASS_FW_BRAIN_UPLOADING', 	'TECH_DIGITAL_SOCIETY', 			8250, 'ART_DEF_BUILDING_LABORATORY',         3,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_BRAIN_UPLOADING', 		'TXT_KEY_BUILDING_FW_BRAIN_UPLOADING_PEDIA', 	'TXT_KEY_BUILDING_FW_BRAIN_UPLOADING_STRATEGY', 	'TXT_KEY_BUILDING_FW_BRAIN_UPLOADING_HELP', 	-1, -20, 80),
	('BUILDING_FW_AI_NETWORK', 				'BUILDINGCLASS_FW_AI_NETWORK', 			'TECH_DIGITAL_SOCIETY', 			8250, 'ART_DEF_BUILDING_LABORATORY',         8,	'BM_ALIENS_CIV_COLOR_ATLAS', 				'TXT_KEY_BUILDING_FW_AI_NETWORK', 				'TXT_KEY_BUILDING_FW_AI_NETWORK_PEDIA', 			'TXT_KEY_BUILDING_FW_AI_NETWORK_STRATEGY', 		'TXT_KEY_BUILDING_FW_AI_NETWORK_HELP', 			-1, -20, 80),
	('BUILDING_FW_ALLOY_FOUNDRY', 			'BUILDINGCLASS_FW_ALLOY_FOUNDRY', 		'TECH_SMART_MATERIALS', 			8500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    13,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_ALLOY_FOUNDRY', 			'TXT_KEY_BUILDING_FW_ALLOY_FOUNDRY_PEDIA', 		'TXT_KEY_BUILDING_FW_ALLOY_FOUNDRY_STRATEGY', 	'TXT_KEY_BUILDING_FW_ALLOY_FOUNDRY_HELP', 		-1, -20, 80),
	('BUILDING_FW_UTILITY_FOG', 			'BUILDINGCLASS_FW_UTILITY_FOG', 		'TECH_SMART_MATERIALS', 			8500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    11,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_UTILITY_FOG', 			'TXT_KEY_BUILDING_FW_UTILITY_FOG_PEDIA', 		'TXT_KEY_BUILDING_FW_UTILITY_FOG_STRATEGY', 	'TXT_KEY_BUILDING_FW_UTILITY_FOG_HELP', 		-1, -20, 80),
	('BUILDING_FW_MOON_BASE', 				'BUILDINGCLASS_FW_MOON_BASE', 			'TECH_ENERGY_THEORY', 				9500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    58,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_MOON_BASE', 				'TXT_KEY_BUILDING_FW_MOON_BASE_PEDIA', 			'TXT_KEY_BUILDING_FW_MOON_BASE_STRATEGY', 		'TXT_KEY_BUILDING_FW_MOON_BASE_HELP', 			-1, -20, 80),
	('BUILDING_FW_CENTRAL_COMMAND', 		'BUILDINGCLASS_FW_CENTRAL_COMMAND', 	'TECH_HYPERSTRUCTURES', 			8250, 'ART_DEF_BUILDING_LABORATORY',        23,	'CIV_COLOR_ATLAS_FW_2', 				'TXT_KEY_BUILDING_FW_CENTRAL_COMMAND', 		'TXT_KEY_BUILDING_FW_CENTRAL_COMMAND_PEDIA', 	'TXT_KEY_BUILDING_FW_CENTRAL_COMMAND_STRATEGY', 	'TXT_KEY_BUILDING_FW_CENTRAL_COMMAND_HELP', 	-1, -20, 80),
	('BUILDING_FW_GENOME_PROJECT_1', 		'BUILDINGCLASS_FW_GENOME_PROJECT_1', 	NULL,                            -1, 'ART_DEF_BUILDING_LABORATORY',        21,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_GENOME_PROJECT_1', 		'TXT_KEY_BUILDING_FW_GENOME_PROJECT_1_PEDIA', 	'TXT_KEY_BUILDING_FW_GENOME_PROJECT_1_STRATEGY', 	'TXT_KEY_BUILDING_FW_GENOME_PROJECT_1_HELP', 	-1, -20, 80),
	('BUILDING_FW_GENOME_PROJECT_2', 		'BUILDINGCLASS_FW_GENOME_PROJECT_2', 	NULL,                            -1, 'ART_DEF_BUILDING_LABORATORY',        21,	'CIV_COLOR_ATLAS_FW_3', 				'TXT_KEY_BUILDING_FW_GENOME_PROJECT_2', 		'TXT_KEY_BUILDING_FW_GENOME_PROJECT_2_PEDIA', 	'TXT_KEY_BUILDING_FW_GENOME_PROJECT_2_STRATEGY', 	'TXT_KEY_BUILDING_FW_GENOME_PROJECT_2_HELP', 	-1, -20, 80);
