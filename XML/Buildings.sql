...
('BUILDING_FW_NANOMAT_PLANT', 			'TECH_NANOMATERIALS', 				4250, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     3,	'CIV_COLOR_ATLAS_FW'),

('BUILDING_FW_AQUACULTURE_LAB', 		'TECH_EUTHENICS', 					5000, 'ART_DEF_BUILDING_LABORATORY',        51,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_FUNGAL_AGRIGENOMICS', 	'TECH_EUTHENICS', 					5000, 'ART_DEF_BUILDING_LABORATORY',        43,	'CIV_COLOR_ATLAS_FW_3'),
('BUILDING_FW_CRYPTOBANK', 				'TECH_GRID_COMPUTING', 				5000, 'ART_DEF_BUILDING_STOCK_EXCHANGE',    15,	'CIV_COLOR_ATLAS_FW_3'),
('BUILDING_FW_UNDERSEA_MINING', 		'TECH_GRID_COMPUTING', 	        	5000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    53,	'CIV_COLOR_ATLAS_FW_2'),

('BUILDING_FW_AUTOPLANT', 				'TECH_POWER_SYSTEMS', 		        5000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    12,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_BIOFUEL_REFINERY', 		'TECH_POWER_SYSTEMS', 				5000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     4,	'CIV_COLOR_ATLAS_FW'),

('BUILDING_FW_VR_TRAINING', 			'TECH_MEMETICS', 					5000, 'ART_DEF_BUILDING_LABORATORY',         0,	'CIV_COLOR_ATLAS_FW_3'),
('BUILDING_FW_VIRTUAL_MUSEUM', 			'TECH_MEMETICS', 					5000, 'MUSEUM',                             39,	'CIV_COLOR_ATLAS_FW_2'),

('BUILDING_FW_NANOFORGE', 				'TECH_NANOTECHNOLOGY', 				5250, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',      8,'TCS_MOD_ICON_ATLAS'),
('BUILDING_FW_PARTICLE_ACCELERATOR', 	'TECH_PARTICLE_PHYSICS', 			5000, 'ART_DEF_BUILDING_LABORATORY',         0,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_VERTICAL_FARM', 			'TECH_ARTIFICIAL_ENVIRONMENTS', 	5000, 'ART_DEF_BUILDING_LABORATORY',         7,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_SEAWATER_ARTIFICIAL_REEF','TECH_ARTIFICIAL_ENVIRONMENTS', 	5000, 'ART_DEF_FEATURE_REEF',                1,	'NW_ATLAS'),
('BUILDING_FW_ECOSANCTUARY', 			'TECH_FW_ECOTHEORY', 	            5750, 'ART_DEF_BUILDING_FW_GARDEN',         31,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_BIOFACTORY', 				'TECH_FW_ECOTHEORY', 				5750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     2,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_IMPLANT_CLINIC', 			'TECH_IMPLANTS', 					4750, 'ART_DEF_BUILDING_LABORATORY',         4,	'CIV_COLOR_ATLAS_FW_3'),
('BUILDING_FW_TELEPRESENCE_HUB', 		'TECH_IMPLANTS',	 		    	4750, 'ART_DEF_BUILDING_LABORATORY',        61,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_NETWORK_BACKBONE', 		'TECH_COGNITIVE_TECH', 				5750, 'ART_DEF_BUILDING_LABORATORY',         1,	'CIV_COLOR_ATLAS_FW'),

('BUILDING_FW_BOREHOLE', 				'TECH_QUANTUM_COMPUTERS',           5750, 'ART_DEF_BUILDING_LABORATORY',        36,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_GEOTHERMAL_FACTORY', 		'TECH_QUANTUM_COMPUTERS', 			5750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    48,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_HYDROTHERMAL_FACTORY', 	'TECH_QUANTUM_COMPUTERS', 			5750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',  	46,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_LAUNCH_FACILITY', 		'TECH_ORBITAL_DEV', 			    5750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    56,	'CIV_COLOR_ATLAS_FW_2'),

('BUILDING_FW_CLONE_LAB', 				'TECH_CLONING', 					6500, 'ART_DEF_BUILDING_LABORATORY',        5, 	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_BIOFLESH_INDUSTRY', 		'TECH_CLONING', 					6500, 'ART_DEF_BUILDING_LABORATORY',        21,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_GENEJACK_FACILITY', 		'TECH_ORGANICS', 		        	6500, 'ART_DEF_BUILDING_LABORATORY',        29,	'CIV_COLOR_ATLAS_FW_3'),

('BUILDING_FW_CONVERTER', 				'TECH_POWER_SYSTEMS', 		        4000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    2,	'CIV_COLOR_ATLAS_FW'),
('BUILDING_FW_CONVERTER_OIL', 			'TECH_POWER_SYSTEMS', 		        4500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    2,	'CIV_COLOR_ATLAS_FW'),
('BUILDING_FW_CONVERTER_IRON', 			'TECH_POWER_SYSTEMS', 		        4500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    2,	'CIV_COLOR_ATLAS_FW'),

('BUILDING_FW_METROPLEX_HUB', 			'TECH_ORGANICS', 			        6500, 'ART_DEF_BUILDING_LABORATORY',        28,	'CIV_COLOR_ATLAS_FW_3'),
('BUILDING_FW_FEEDSITE_HUB', 			'TECH_ORGANICS', 		            6500, 'ART_DEF_BUILDING_LABORATORY',        40,	'CIV_COLOR_ATLAS_FW_3'),
('BUILDING_FW_DISTRIBUTION_HUB', 		'TECH_NUCLEAR_ENRICHMENT', 		    6500, 'ART_DEF_BUILDING_LABORATORY',        61,	'CIV_COLOR_ATLAS_FW_3'),
('BUILDING_FW_SIMULATION_HUB', 			'TECH_NUCLEAR_ENRICHMENT', 		    6500, 'ART_DEF_BUILDING_LABORATORY',         6,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_ENRICHMENT_FACILITY', 	'TECH_NUCLEAR_ENRICHMENT', 			6750, 'ART_DEF_BUILDING_LABORATORY',        40,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_SPACE_STATION', 			'TECH_ASTRODYNAMICS', 				6500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    52,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_MYCOPROTEIN_VATS', 		'TECH_ASTRODYNAMICS', 		    	6500, 'ART_DEF_BUILDING_LABORATORY',        60,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_RESEARCH_MODULE', 		'TECH_ASTRODYNAMICS', 		    	7000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    24,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_ENGINEERING_MODULE', 		'TECH_ASTRODYNAMICS', 		    	7000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    25,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_COMM_MODULE', 			'TECH_ASTRODYNAMICS', 		   	 	7000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    28,	'CIV_COLOR_ATLAS_FW_2'),

('BUILDING_FW_TIDAL_PORT', 				'TECH_NEURAL_INTERFACE', 		    7250, 'ART_DEF_BUILDING_FW_HYDRO_ARRAY',    57,	'TCS_MOD_ICON_ATLAS'),
('BUILDING_FW_CYBERCLINIC', 			'TECH_NEURAL_INTERFACE', 			7250, 'ART_DEF_BUILDING_LABORATORY',         8,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_NEURAL_LINK', 			'TECH_NEURAL_INTERFACE', 			8250, 'ART_DEF_BUILDING_LABORATORY',         1,	'CIV_COLOR_ATLAS_FW_LINKS'),
('BUILDING_FW_COMBAT_LINK', 			'TECH_NEURAL_INTERFACE', 			8250, 'ART_DEF_BUILDING_LABORATORY',         2,	'CIV_COLOR_ATLAS_FW_LINKS'),
('BUILDING_FW_CORTICAL_LINK', 			'TECH_NEURAL_INTERFACE', 			8250, 'ART_DEF_BUILDING_LABORATORY',         3,	'CIV_COLOR_ATLAS_FW_LINKS'),
('BUILDING_FW_HIGHSPEED_RAIL', 			'TECH_SUPERCONDUCTIVITY', 			7250, 'ART_DEF_BUILDING_GARDEN',             2,	'CIV_COLOR_ATLAS_FW_3'),
('BUILDING_FW_AEROSPACE_COMPLEX', 		'TECH_SUPERCONDUCTIVITY', 		   	7250, 'ART_DEF_BUILDING_AIRPORT',           30,	'CIV_COLOR_ATLAS_FW_3'),

('BUILDING_FW_TRANSGENIC_NURSERY', 		'TECH_TRANSGENICS', 				7250, 'ART_DEF_BUILDING_LABORATORY',        59,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_DRONE_HIVE', 				'TECH_AUTONOMOUS_SYSTEMS', 			7250, 'ART_DEF_BUILDING_LABORATORY',         9,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_NANOMINES_FIELD', 		'TECH_ARCOLOGIES', 			        7250, 'ART_DEF_BUILDING_GARDEN',             2,	'CIV_COLOR_ATLAS_FW_ICONS'),
('BUILDING_FW_DEFENSE_FIELD', 			'TECH_ARCOLOGIES', 			        7250, 'ART_DEF_BUILDING_FW_MILITARY_BASE',  33,	'CIV_COLOR_ATLAS_FW_3'),

('BUILDING_FW_ECTOGENESIS_POD', 		'TECH_GENGINEERING', 				7750, 'ART_DEF_BUILDING_LABORATORY',        22,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_MASS_DIGESTER', 			'TECH_BIOMODIFICATION', 	    	7750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     4,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_BIOMOD_TANK', 			'TECH_BIOMODIFICATION', 			7750, 'ART_DEF_BUILDING_LABORATORY',        30,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_DIGITAL_POLICE', 			'TECH_AI', 		                	7750, 'COLESSEUM',                           1,	'CIV_COLOR_ATLAS_FW_ICONS'),
('BUILDING_FW_FUSION_PLANT', 			'TECH_NUCLEAR_FUSION', 				7750, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',     6,	'CIV_COLOR_ATLAS_FW'),
('BUILDING_FW_ALLOY_FOUNDRY', 			'TECH_NUCLEAR_FUSION', 			8500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    13,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_ORBITAL_HABITAT', 		'TECH_ADAMANTIUM', 	                8250, 'ART_DEF_BUILDING_HOSPITAL',          26,	'CIV_COLOR_ATLAS_FW_3'),
('BUILDING_FW_ORBITAL_REFINERY', 		'TECH_ADAMANTIUM', 					9000, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    57,	'CIV_COLOR_ATLAS_FW_2'),

('BUILDING_FW_TERRAFORMING_STATION', 	'TECH_TERRAFORMING', 				8250, 'ART_DEF_BUILDING_LABORATORY',        36,	'CIV_COLOR_ATLAS_FW'),
('BUILDING_FW_PHOTOSYSTEMS', 			'TECH_TERRAFORMING', 				8250, 'ART_DEF_BUILDING_LABORATORY',        35,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_BIRTHING_PODS', 			'TECH_HUMAN_AUGMENTATION', 			8250, 'ART_DEF_BUILDING_LABORATORY',        62,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_BRAIN_UPLOADING', 		'TECH_DIGITAL_SOCIETY', 			8250, 'ART_DEF_BUILDING_LABORATORY',         3,	'CIV_COLOR_ATLAS_FW_3'),
('BUILDING_FW_AI_NETWORK', 				'TECH_DIGITAL_SOCIETY', 			8250, 'ART_DEF_BUILDING_LABORATORY',         8,	'BM_ALIENS_CIV_COLOR_ATLAS'),
('BUILDING_FW_UTILITY_FOG', 			'TECH_SMART_MATERIALS', 			8500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    11,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_MOON_BASE', 				'TECH_ENERGY_THEORY', 				9500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    58,	'CIV_COLOR_ATLAS_FW_2'),
('BUILDING_FW_CENTRAL_COMMAND', 		'TECH_HYPERSTRUCTURES', 			8250, 'ART_DEF_BUILDING_LABORATORY',        23,	'CIV_COLOR_ATLAS_FW_2'),
