...
('BUILDING_FW_CYBERPOLICE', 			'TECH_SUPERCOMPUTERS', 				4250, 'COLESSEUM',                          11,	'EXPANSION_BW_ATLAS_1'),
('BUILDING_FW_ONLINE_SCHOOL', 			'TECH_SUPERCOMPUTERS', 				4250, 'ART_DEF_BUILDING_LABORATORY',         7,	'BW_ATLAS_1'),
...
('BUILDING_FW_NEURAL_LINK', 			'TECH_NEURAL_INTERFACE', 			8250, 'ART_DEF_BUILDING_LABORATORY',        49,	'BUILDING_ATLAS_VP_2'),
('BUILDING_FW_COMBAT_LINK', 			'TECH_NEURAL_INTERFACE', 			8250, 'ART_DEF_BUILDING_LABORATORY',        47,	'BUILDING_ATLAS_VP_2'),
('BUILDING_FW_CORTICAL_LINK', 			'TECH_NEURAL_INTERFACE', 			8250, 'ART_DEF_BUILDING_LABORATORY',        51,	'BUILDING_ATLAS_VP_2'),
...
('BUILDING_FW_NANOMINES_FIELD', 		'TECH_ARCOLOGIES', 			        7250, 'ART_DEF_BUILDING_GARDEN',            14,	'BUILDING_ATLAS_VP_2'),
...
('BUILDING_FW_DIGITAL_POLICE', 			'TECH_AI', 		                	7750, 'COLESSEUM',                          11,	'EXPANSION_BW_ATLAS_1'),
...
('BUILDING_FW_ALLOY_FOUNDRY', 			'TECH_SMART_MATERIALS', 			8500, 'ART_DEF_BUILDING_FW_HYDRO_PLANT',    13,	'CIV_COLOR_ATLAS_FW_2'),
...
SET GoldMaintenance = 16,
	...
	PortraitIndex = (SELECT PortraitIndex FROM Buildings WHERE Type = 'BUILDING_PUBLIC_SCHOOL'),
	IconAtlas = (SELECT IconAtlas FROM Buildings WHERE Type = 'BUILDING_PUBLIC_SCHOOL')
...
----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 11, NeverCapture = 1
...
SET NeverCapture = 1,
	...
	PortraitIndex = (SELECT PortraitIndex FROM Buildings WHERE Type = 'BUILDING_INTERNATIONAL_FINANCE_CENTER'),
	IconAtlas = (SELECT IconAtlas FROM Buildings WHERE Type = 'BUILDING_INTERNATIONAL_FINANCE_CENTER')
WHERE Type = 'BUILDING_FW_NEURAL_LINK';

INSERT INTO Building_BuildingClassYieldChanges
	(BuildingType, BuildingClassType, YieldType, YieldChange)
SELECT
	'BUILDING_FW_NEURAL_LINK', FranchiseBuildingClass, 'YIELD_GOLD', 2
FROM Corporations;
INSERT INTO Building_BuildingClassYieldChanges
	(BuildingType, BuildingClassType, YieldType, YieldChange)
SELECT
	'BUILDING_FW_NEURAL_LINK', FranchiseBuildingClass, 'YIELD_CULTURE', 2
FROM Corporations;
INSERT INTO Building_BuildingClassYieldChanges
	(BuildingType, BuildingClassType, YieldType, YieldChange)
SELECT
	'BUILDING_FW_NEURAL_LINK', FranchiseBuildingClass, 'YIELD_TOURISM', 2
FROM Corporations;
----------------------------------------------
...
SET NeverCapture = 1,
	...
	PortraitIndex = (SELECT PortraitIndex FROM Buildings WHERE Type = 'BUILDING_HALL_OF_HONOR'),
	IconAtlas = (SELECT IconAtlas FROM Buildings WHERE Type = 'BUILDING_HALL_OF_HONOR')
...
SET NeverCapture = 1,
	...
	PortraitIndex = (SELECT PortraitIndex FROM Buildings WHERE Type = 'BUILDING_PALACE_CULTURE_SCIENCE'),
	IconAtlas = (SELECT IconAtlas FROM Buildings WHERE Type = 'BUILDING_PALACE_CULTURE_SCIENCE')
...
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 15, NeverCapture = 1, NoUnhappfromXSpecialists = 1, TrainedFreePromotion = 'PROMOTION_FLANK_ATTACK_BONUS'
...
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 13, NeverCapture = 1, LandmarksTourismPercent = 15, MutuallyExclusiveGroup = 23492, NoUnhappfromXSpecialists = 1, BoredomFlatReduction = 1, ReligiousUnrestFlatReduction = 1
WHERE Type = 'BUILDING_FW_ECOSANCTUARY';
-- ----------------------------------------------
-- -- Biofactory
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 15, NeverCapture = 1, ProhibitedCityTerrain = 'TERRAIN_SNOW', NoUnhappfromXSpecialists = 1, MutuallyExclusiveGroup = 23492
WHERE Type = 'BUILDING_FW_BIOFACTORY';
-- ----------------------------------------------
-- -- Geothermal Factory
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 16, NeverCapture = 1, NearbyMountainRequired = 1, NoUnhappfromXSpecialists = 1, MutuallyExclusiveGroup = 23492
WHERE Type = 'BUILDING_FW_GEOTHERMAL_FACTORY';
-- ----------------------------------------------
-- -- Hydrothermal Factory
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 16, NeverCapture = 1, Water = 1, MinAreaSize = 10, NoUnhappfromXSpecialists = 1, MutuallyExclusiveGroup = 23492
...
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 10, MutuallyExclusiveGroup = 40961, Water = 1, MinAreaSize = 10, TechEnhancedTourism = 0
...
-- ('BUILDING_FW_NEURAL_LINK',  		'YIELD_CULTURE', 	4),
-- ('BUILDING_FW_COMBAT_LINK',  		'YIELD_CULTURE', 	4),
-- ('BUILDING_FW_COMBAT_LINK',  		'YIELD_TOURISM', 	15),
-- ('BUILDING_FW_CORTICAL_LINK',  		'YIELD_CULTURE', 	4),
...
INSERT INTO Corporation_BuildingClassYieldChanges 
 ...
 VALUES
	...
	-- ('CORPORATION_CIVILIZED_JEWELERS', 	'BUILDINGCLASS_FW_TERRAFORMING_STATION', 	'YIELD_GOLDEN_AGE_POINTS', 	4),
...
VALUES
	...
	('BUILDING_FW_UTILITY_FOG',			'RESOURCE_NANOMAT',		1),
	('BUILDING_FW_UTILITY_FOG',			'RESOURCE_ADN_FUNGUS',	1),
	('BUILDING_FW_UTILITY_FOG',			'RESOURCE_IMPLANT',		1),
...
INSERT INTO Policy_BuildingClassYieldChanges (PolicyType, BuildingClassType, YieldType, YieldChange)
SELECT DISTINCT PolicyType, 'BUILDINGCLASS_FW_DEFENSE_FIELD', YieldType, YieldChange
FROM Policy_BuildingClassYieldChanges WHERE PolicyType = 'POLICY_NAVAL_TRADITION';
INSERT INTO Policy_BuildingClassCultureChanges (PolicyType, BuildingClassType, CultureChange)
SELECT DISTINCT PolicyType, 'BUILDINGCLASS_FW_DEFENSE_FIELD', CultureChange
FROM Policy_BuildingClassCultureChanges WHERE PolicyType = 'POLICY_NAVAL_TRADITION';

INSERT INTO Policy_BuildingClassYieldChanges (PolicyType, BuildingClassType, YieldType, YieldChange)
SELECT DISTINCT PolicyType, 'BUILDINGCLASS_FW_UTILITY_FOG', YieldType, YieldChange
FROM Policy_BuildingClassYieldChanges WHERE PolicyType = 'POLICY_NAVAL_TRADITION';
INSERT INTO Policy_BuildingClassCultureChanges (PolicyType, BuildingClassType, CultureChange)
SELECT DISTINCT PolicyType, 'BUILDINGCLASS_FW_UTILITY_FOG', CultureChange
FROM Policy_BuildingClassCultureChanges WHERE PolicyType = 'POLICY_NAVAL_TRADITION';
...
VALUES
	...
	-- ('BUILDING_FW_NEURAL_LINK', 		'YIELD_FOOD', 		5),
	-- ('BUILDING_FW_NEURAL_LINK', 		'YIELD_GOLD', 		5),
	-- ('BUILDING_FW_COMBAT_LINK', 		'YIELD_PRODUCTION', 5),
	-- ('BUILDING_FW_CORTICAL_LINK', 	'YIELD_SCIENCE', 	5);
...
VALUES
	...
	-- ('BUILDING_FW_NANOFORGE', 		'DOMAIN_HOVER', 10),
	('BUILDING_FW_AI_NETWORK', 		'DOMAIN_LAND', 	20),
	('BUILDING_FW_AI_NETWORK', 		'DOMAIN_HOVER', 20),
	...
	-- ('BUILDING_FW_DRONE_HIVE', 			'DOMAIN_HOVER', 	5),
	('BUILDING_FW_DRONE_HIVE', 			'DOMAIN_LAND', 		5),
