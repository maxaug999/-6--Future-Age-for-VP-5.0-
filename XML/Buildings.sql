...
----------------------------------------------
UPDATE Buildings
SET NeverCapture = 1, NukeImmune = 1, NationalPopRequired = 200, SpecialistType = 'SPECIALIST_SCIENTIST', SpecialistCount = 2, Happiness = 3, NoUnhappfromXSpecialists = 2
...
VALUES
	...
	('BUILDING_FW_GENE_LAB', 				'RESOURCE_ROME_FIGS', 	'YIELD_FOOD', 2),
	...
	('BUILDING_FW_BIOFUEL_REFINERY', 		'RESOURCE_ROME_FIGS', 'YIELD_FOOD', -1),
	('BUILDING_FW_BIOFUEL_REFINERY', 		'RESOURCE_ROME_FIGS', 'YIELD_GOLD', 1),
...
('BUILDING_FW_MOON_BASE', 			'FLAVOR_PRODUCTION', 		5),
('BUILDING_FW_MOON_BASE', 			'FLAVOR_SCIENCE', 			5),
('BUILDING_FW_MOON_BASE', 			'FLAVOR_GOLD', 				5),
('BUILDING_FW_MOON_BASE', 			'FLAVOR_OFFENSE', 			5),
('BUILDING_FW_MOON_BASE', 			'FLAVOR_EXPANSION', 		10),
('BUILDING_FW_MOON_BASE', 			'FLAVOR_SPACESHIP', 		10),
('BUILDING_FW_MOON_BASE', 			'FLAVOR_MILITARY_TRAINING', 10),
