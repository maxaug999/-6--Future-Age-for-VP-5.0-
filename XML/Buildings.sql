...
-- ----------------------------------------------
UPDATE Buildings
SET FoodKept = 12, Water = 1, MutuallyExclusiveGroup = 40961, MinAreaSize = 1
...
VALUES
	...
	('BUILDING_FW_BOREHOLE', 			 'IMPROVEMENT_FW_GENERATOR', 			'YIELD_PRODUCTION', 1),
	...
	('BUILDING_FW_ECOSANCTUARY', 		 'IMPROVEMENT_POLDER', 					'YIELD_PRODUCTION', 1),
...
VALUES
	...
	('BUILDING_FW_HYDROTHERMAL_FACTORY', 	'BUILDINGCLASS_FW_HYDROTHERMAL_FACTORY', 	'YIELD_FOOD', 					1),
...
VALUES
	('BUILDING_FW_NANOFORGE', 		'DOMAIN_LAND', 	10),
	('BUILDING_FW_NANOFORGE', 		'DOMAIN_SEA', 	   10),
	('BUILDING_FW_AI_NETWORK', 	'DOMAIN_LAND', 	20),
	('BUILDING_FW_LAUNCH_FACILITY', 'DOMAIN_AIR', 	10),
...
('BUILDING_FW_NEURAL_LINK', 				'FLAVOR_HAPPINESS', 			10),
('BUILDING_FW_NEURAL_LINK', 				'FLAVOR_CULTURE', 			10),
('BUILDING_FW_NEURAL_LINK', 				'FLAVOR_WONDER', 				10),
('BUILDING_FW_COMBAT_LINK', 				'FLAVOR_DIPLOMACY', 			100),
...
('BUILDING_FW_CORTICAL_LINK', 			'FLAVOR_DIPLOMACY', 			100),
('BUILDING_FW_CORTICAL_LINK', 			'FLAVOR_CITY_DEFENSE', 		50),
('BUILDING_FW_CORTICAL_LINK', 			'FLAVOR_DEFENSE', 			20),
...
('BUILDING_FW_GEOTHERMAL_FACTORY', 		'FLAVOR_PRODUCTION', 			75),
...
('BUILDING_FW_HYDROTHERMAL_FACTORY', 	'FLAVOR_PRODUCTION', 			60),
('BUILDING_FW_HYDROTHERMAL_FACTORY', 	'FLAVOR_SCIENCE', 				30),
('BUILDING_FW_HYDROTHERMAL_FACTORY', 	'FLAVOR_GROWTH', 					30),
('BUILDING_FW_HYDROTHERMAL_FACTORY', 	'FLAVOR_NAVAL_TILE_IMPROVEMENT', 15),
('BUILDING_FW_HYDROTHERMAL_FACTORY', 	'FLAVOR_TILE_IMPROVEMENT', 	10),
