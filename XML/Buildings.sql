...
VALUES
	('BUILDING_FW_TERRAFORMING_STATION', 'YIELD_GOLDEN_AGE_POINTS', 750),
...
----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 5, SpecialistType = 'SPECIALIST_MERCHANT', SpecialistCount = 1, GreatPeopleRateChange = 2, MutuallyExclusiveGroup = 9993, PovertyFlatReduction = 1
...
INSERT INTO Building_YieldFromProcessModifier
	(BuildingType, 				  YieldType, 		Yield)
VALUES
	('BUILDING_FW_FUSION_PLANT', 'YIELD_TOURISM', 	20),
...
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 15, NeverCapture = 1, LandmarksTourismPercent = 15, MutuallyExclusiveGroup = 23492, NoUnhappfromXSpecialists = 1, BoredomFlatReduction = 1, ReligiousUnrestFlatReduction = 1
...
INSERT INTO Corporation_BuildingClassYieldChanges 
 ...
 VALUES
	...
	('CORPORATION_TWOKAY_FOODS', 	   	'BUILDINGCLASS_FW_BIOFACTORY', 				'YIELD_FOOD', 				2),
...
('BUILDING_FW_ECOSANCTUARY', 				'FLAVOR_CULTURE', 				50),
('BUILDING_FW_ECOSANCTUARY', 				'FLAVOR_PRODUCTION', 			40),
('BUILDING_FW_ECOSANCTUARY', 				'FLAVOR_FAITH', 					15),
...
('BUILDING_FW_HYDROTHERMAL_FACTORY', 	'FLAVOR_GROWTH', 					20),
...
('BUILDING_FW_BOREHOLE', 					'FLAVOR_GOLD', 					60),
...
('BUILDING_FW_FUSION_PLANT', 		'FLAVOR_GREAT_PEOPLE', 		75),
