...
('BUILDINGCLASS_FW_ORBITAL_REFINERY', 		 'BUILDING_FW_ORBITAL_REFINERY', 		'TXT_KEY_BUILDING_FW_ORBITAL_REFINERY',		1),
...
----------------------------------------------
UPDATE Buildings
SET NeverCapture = 1, NukeImmune = 1, NoUnhappfromXSpecialists = 1, NationalPopRequired = 180,  SpecialistType = 'SPECIALIST_ENGINEER', SpecialistCount = 2
WHERE Type = 'BUILDING_FW_ORBITAL_REFINERY';
INSERT INTO Building_YieldFromConstruction
	(BuildingType, YieldType, Yield)
VALUES
	('BUILDING_FW_ORBITAL_REFINERY', 'YIELD_SCIENCE', 	75),
	('BUILDING_FW_ORBITAL_REFINERY', 'YIELD_GOLD', 		75),
	('BUILDING_FW_ORBITAL_REFINERY', 'YIELD_TOURISM', 	75);
...
CROSS JOIN (
	...
	SELECT 'BUILDINGCLASS_FW_ORBITAL_REFINERY' UNION ALL
...
('BUILDING_FW_ORBITAL_REFINERY',  		'FLAVOR_WONDER',      		20),
('BUILDING_FW_ORBITAL_REFINERY',  		'FLAVOR_DIPLOMACY', 		25),
('BUILDING_FW_ORBITAL_REFINERY',  		'FLAVOR_PRODUCTION',      	35),
...
('BUILDING_FW_MOON_BASE', 			'FLAVOR_DIPLOMACY', 		10),
('BUILDING_FW_MOON_BASE', 			'FLAVOR_HAPPINESS', 		10),
('BUILDING_FW_MOON_BASE', 			'FLAVOR_EXPANSION', 		10),
('BUILDING_FW_MOON_BASE', 			'FLAVOR_SPACESHIP', 		10),
