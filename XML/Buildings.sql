...
('BUILDING_FW_NANOMINES_FIELD', 		'TECH_ARCOLOGIES', 			        7250, 'ART_DEF_BUILDING_GARDEN',            18,	'COMMUNITY_ATLAS'),
...
-- ----------------------------------------------
UPDATE Buildings
SET NeverCapture = 1, GoldMaintenance = 20, NationalPopRequired = 125
...
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 5, NeverCapture = 1, MutuallyExclusiveGroup = 3612
...
-- ----------------------------------------------
UPDATE Buildings
SET ProhibitedCityTerrain = 'TERRAIN_COAST', Water = 0, MinAreaSize = 0, GoldMaintenance = 26, Defense = 1800, AllowsRangeStrike = 1, ExtraCityHitPoints = 140, NukeImmune = 1, NukeModifier = -15, NukeInterceptionChance = 15
...
-- ----------------------------------------------
UPDATE Buildings
SET GoldMaintenance = 14, DistressFlatReduction = 1, CityAirStrikeDefense = 5, TrainedFreePromotion = 'PROMOTION_ANTIAIR_LAND_1'
...
VALUES
	...
	('BUILDING_FW_AI_NETWORK', 		 	 'IMPROVEMENT_ZULU_KRAAL', 				'YIELD_CULTURE_LOCAL', 	3),
	('BUILDING_FW_AI_NETWORK', 		 	 'IMPROVEMENT_CELTS_OPPIDUM', 			'YIELD_GOLD', 			2),
	('BUILDING_FW_AI_NETWORK', 		 	 'IMPROVEMENT_CELTS_OPPIDUM', 			'YIELD_CULTURE_LOCAL', 	3),
	...
	('BUILDING_FW_AI_NETWORK', 		 	 'IMPROVEMENT_OTTOMAN_TERSANE', 		'YIELD_CULTURE_LOCAL', 	3),
...
('BUILDING_FW_BRAIN_UPLOADING', 	'FLAVOR_HAPPINESS', 		20),
