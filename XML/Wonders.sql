...
('BUILDING_FW_SKYTREE',     	  	 	'TECH_MEMETICS',     	   3750, 'ART_DEF_BUILDING_LABORATORY',  0,'BW_ATLAS_SKYTREE', 	  		1, 28, 		'SkyTree_splash.dds', 				'R,T'),
('BUILDING_FW_SHANGHAI_WFC', 		    'TECH_GLOBALIZATION', 	   3250, 'ART_DEF_BUILDING_LABORATORY',  1,'BW_ATLAS_CHINESE_NEW_YEAR', 1, 27, 		'SHANGHAI_WFC_splash.dds', 			'L,T'),
('BUILDING_FW_NANO_INSTITUTE',    	 	'TECH_NANOTECHNOLOGY',     3750, 'ART_DEF_BUILDING_LABORATORY',  17,'CIV_COLOR_ATLAS_FW_2', 	1, 27, 		'SkyTree_splash_a.dds', 			'L,T'),
('BUILDING_FW_GENE_VAULT', 				'TECH_FW_ECOTHEORY',       4250, 'ART_DEF_BUILDING_LABORATORY',  42,'CIV_COLOR_ATLAS_FW_3', 	1, 28, 		'GeneVault_Splash.dds',		 		'L,T'),
('BUILDING_FW_ECOPOLIS', 				'TECH_ARTIFICIAL_ENVIRONMENTS', 4250, 'ART_DEF_BUILDING_FW_GARDEN',  0,'CIV_COLOR_ATLAS_FW_ECOPOLIS', 	1, 28, 		'Ecopolis_Splash.dds',		 		'L,T'),
('BUILDING_FW_APEX_CENTRE',     	 	'TECH_IMPLANTS',           4250, 'ART_DEF_BUILDING_LABORATORY',  39,'CIV_COLOR_ATLAS_FW_3', 	1, 28, 		'ApexCentre_Splash.dds', 			'L,T'),
('BUILDING_FW_VIRTUAL_IDOL', 			'TECH_COGNITIVE_TECH',     4250, 'ART_DEF_BUILDING_LABORATORY',  17, 'CIV_COLOR_ATLAS_FW_3', 	1, 28, 		'VirtualIdol_Splash.dds',		 	'L,T'),
('BUILDING_FW_ENRICHMENT_CENTRE', 		'TECH_NUCLEAR_ENRICHMENT', 4750, 'ART_DEF_BUILDING_LABORATORY',  7, 'CIV_COLOR_ATLAS_FW_3', 	1, 28, 		'EnrichmentCentre_Splash.dds',		'L,T'),
('BUILDING_FW_JURASSIC_PARK',     	 	'TECH_CLONING',            4750, 'ART_DEF_BUILDING_LABORATORY',  5,'CIV_COLOR_ATLAS_FW_3', 		1, 30, 		'JurassicPark_Splash.dds', 			'L,T'),
('BUILDING_FW_HELIOS', 					'TECH_ASTRODYNAMICS',      4750, 'ART_DEF_BUILDING_LABORATORY',  19,'CIV_COLOR_ATLAS_FW_2', 	1, 30, 		'Helios_Splash.dds',		 		'L,T'),
('BUILDING_FW_PHOLUS_MUTAGEN', 			'TECH_TRANSGENICS',    	   5500, 'ART_DEF_BUILDING_LABORATORY',  26, 'CIV_COLOR_ATLAS_FW_2', 	1, 30, 		'PholusMutagen_Splash.dds',		 	'L,T'),
('BUILDING_FW_DATA_HAVEN', 	  	  	 	'TECH_AUTONOMOUS_SYSTEMS', 5500, 'ART_DEF_BUILDING_LABORATORY',  3,'CIV_COLOR_ATLAS_FW_2', 		1, 30, 		'DataHaven_Splash.dds', 			'R,B'),
('BUILDING_FW_SHIMIZUMCP', 		  	 	'TECH_ARCOLOGIES',    	   5500, 'ART_DEF_BUILDING_LABORATORY',  16,'CIV_COLOR_ATLAS_FW_2', 	1, 32, 		'FWShimizuMCP_Splash.dds', 			'L,T'),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE', 	'TECH_GENGINEERING',       5750, 'ART_DEF_BUILDING_FW_GARDEN',   16,'CIV_COLOR_ATLAS_FW_3', 	1, 32, 		'NephilimGeneTemplate_Splash.dds', 	'L,T'),
('BUILDING_FW_MNEMOSYNE', 				'TECH_CYBERNETICS',    	   5750, 'ART_DEF_BUILDING_LABORATORY',  45, 'CIV_COLOR_ATLAS_FW_2', 	1, 32, 		'Mnemosyne_Splash.dds',		 		'L,T'),
('BUILDING_FW_SKYNET', 					'TECH_AI', 	  		 	   5750, 'ART_DEF_BUILDING_LABORATORY',  32,'CIV_COLOR_ATLAS_FW_3', 	1, 32, 		'Skynet_Splash.dds',		 		'L,T'),
('BUILDING_FW_CITADEL_STATION', 		'TECH_NUCLEAR_FUSION',     5750, 'ART_DEF_BUILDING_LABORATORY',  6, 'CIV_COLOR_ATLAS_FW_3', 	1, 32, 		'CitadelStation_Splash.dds',		'R,T'),
-- ('BUILDING_FW_ORBITAL_REFINERY', 		'TECH_ADAMANTIUM',         5250, 'ART_DEF_BUILDING_LABORATORY',  57,'CIV_COLOR_ATLAS_FW_2', 	1, 32, 		'OrbitalRefinery_Splash.dds', 		'L,T'),
('BUILDING_FW_FLOATINGISLANDS',   	 	'TECH_TERRAFORMING', 	   7000, 'ART_DEF_BUILDING_LABORATORY',  50,'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'LivingCity_Splash.dds', 	        'L,T'),
('BUILDING_FW_DIGITAL_EMANCIPATION', 	'TECH_DIGITAL_SOCIETY',    7000, 'ART_DEF_BUILDING_LABORATORY',  43, 'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'DigitalEmancipation_Splash.dds',	'L,T'),
('BUILDING_FW_ANGELNET', 				'TECH_SMART_MATERIALS',    7000, 'ART_DEF_BUILDING_LABORATORY',  38,'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'Angelnet_Splash.dds',		 		'L,T'),
('BUILDING_FW_ULTIMATOWER', 	  	 	'TECH_HYPERSTRUCTURES',    7000, 'ART_DEF_BUILDING_LABORATORY',  49,'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'FWUltimaTower_Splash.dds', 		'L,T'),
('BUILDING_FW_BIONICTOWER', 	  	 	'TECH_HYPERSTRUCTURES',    7000, 'ART_DEF_BUILDING_LABORATORY',  29,'CIV_COLOR_ATLAS_FW_2',		1, 34, 		'FWBionicTower_Splash.dds', 		'C,T'),
('BUILDING_FW_BUENOSAIRESFORUM',  	 	'TECH_HYPERSTRUCTURES',    7000, 'ART_DEF_BUILDING_LABORATORY',  47,'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'FWBuenosAiresForum_Splash.dds',	'L,T'),
('BUILDING_FW_SKYCITY', 	  	  	 	'TECH_HYPERSTRUCTURES',    7000, 'ART_DEF_BUILDING_LABORATORY',  36,'CIV_COLOR_ATLAS_FW_3', 	1, 34, 		'KingdomTowerCT_Splash.dds', 		'R,T'),
...
-- Move Hubble
UPDATE Buildings
SET PrereqTech = 'TECH_ORBITAL_DEV', Cost = 4250
...
----------------------------------------------
UPDATE Buildings
SET FreeBuildingThisCity = 'BUILDINGCLASS_FW_BRAIN_UPLOADING', GlobalGreatPeopleRateModifier = 30, FreeGreatPeople = 1, LocalPopRequired = 75
...
----------------------------------------------
UPDATE Buildings
SET SpecialistType = 'SPECIALIST_MUSICIAN', SpecialistCount = 2, BoredomFlatReduction = 2, GreatPeopleRateChange = 1, Happiness = 1, GreatWorkSlotType = 'GREAT_WORK_SLOT_MUSIC', GreatWorkCount = 2, GreatWorksTourismModifier = 25, CultureRateModifier = 10
...
----------------------------------------------
UPDATE Buildings
SET SpecialistType = 'SPECIALIST_ENGINEER', SpecialistCount = 1, GreatPeopleRateChange = 2, Happiness = 1, FoodKept = 15, FreeBuildingThisCity = 'BUILDINGCLASS_FW_VERTICAL_FARM', FreePromotion = 'PROMOTION_FW_ECOPOLIS'
WHERE Type = 'BUILDING_FW_ECOPOLIS';
...
----------------------------------------------
-- UPDATE Buildings
-- SET SpecialistType = 'SPECIALIST_ENGINEER', GreatPeopleRateChange = 2, NationalPopRequired = 150
...
----------------------------------------------
UPDATE Buildings
SET Happiness = 4, MutuallyExclusiveGroup = 23497, FreeBuildingThisCity = 'BUILDINGCLASS_FW_BIRTHING_PODS', FreePromotion = 'PROMOTION_FW_NEPHILIM'
...
----------------------------------------------
UPDATE Buildings
SET ProhibitedCityTerrain = 'TERRAIN_COAST', MinAreaSize = 0, SpecialistType = 'SPECIALIST_SCIENTIST', GreatPeopleRateChange = 2, TechEnhancedTourism = 3, Happiness = 4, BorderObstacle = 1, FreeBuildingThisCity = 'BUILDINGCLASS_FW_CLONE_LAB', Defense = 1700, ExtraCityHitPoints = 150
...
-- ----------------------------------------------
UPDATE Buildings
SET FreeTechs = 1, cost = 3750, FreeBuildingThisCity = 'BUILDINGCLASS_FW_PARTICLE_ACCELERATOR'
...
----------------------------------------------
UPDATE Buildings
SET SpecialistType = 'SPECIALIST_ENGINEER', SpecialistCount = 2, GreatPeopleRateChange = 5, BuildingProductionModifier = 50, GlobalPopulationChange = 4, Happiness = 1, PolicyType = 'POLICY_EXPLORATION_FINISHER'
...
-- ('BUILDING_FW_ORBITAL_REFINERY',  			'YIELD_PRODUCTION', 	4),
...
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE',  	'YIELD_GOLDEN_AGE_POINTS', 	4),
...
('BUILDING_FW_JURASSIC_PARK',  				'YIELD_TOURISM', 		6),
...
('BUILDING_FW_ECOPOLIS',  					'YIELD_FOOD', 			5),
('BUILDING_FW_ECOPOLIS',  					'YIELD_CULTURE', 		3),
('BUILDING_FW_ECOPOLIS',  					'YIELD_TOURISM', 		6),
...
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE', 				'YIELD_FAITH', 					25),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE', 				'YIELD_GOLDEN_AGE_POINTS', 		25),
('BUILDING_FW_SKYNET', 								'YIELD_SCIENCE', 				25),
('BUILDING_FW_SKYNET', 								'YIELD_PRODUCTION', 			25),
...
VALUES
	...
	('BUILDING_FW_SKYNET', 					'RESOURCE_IMPLANT', 	2),
	('BUILDING_FW_NEPHILIM_GENE_TEMPLATE', 	'RESOURCE_ADN_FUNGUS', 	2),
	('BUILDING_FW_CITADEL_STATION', 		'RESOURCE_IMPLANT', 	2),
	('BUILDING_FW_FLOATINGISLANDS', 		'RESOURCE_ADN_FUNGUS', 	3),
	('BUILDING_FW_BIONICTOWER', 			'RESOURCE_NANOMAT', 	3),
	('BUILDING_FW_SKYCITY', 				'RESOURCE_NANOMAT', 	3),
	('BUILDING_FW_ULTIMATOWER', 			'RESOURCE_NANOMAT', 	3),
	('BUILDING_FW_BUENOSAIRESFORUM', 		'RESOURCE_NANOMAT', 	3);
...
VALUES
	...
	('BUILDING_FW_ECOPOLIS', 		'FEATURE_MARSH');
...
VALUES
	...
	-- ('BUILDING_FW_ORBITAL_REFINERY', 	'RESOURCE_NANOMAT', 		6),
	-- ('BUILDING_FW_ORBITAL_REFINERY', 	'RESOURCE_IMPLANT', 		6),
...
VALUES
	...
	('BUILDING_FW_JURASSIC_PARK', 	  	 'BUILDINGCLASS_THEATRE',  				'YIELD_TOURISM', 			3),
	('BUILDING_FW_JURASSIC_PARK', 	  	 'BUILDINGCLASS_FW_CLONE_LAB',  		'YIELD_SCIENCE', 			3),
...
VALUES
	...
	('BUILDING_FW_SKYCITY', 			'SPECIALIST_WRITER', 		30),
	('BUILDING_FW_SKYCITY', 			'SPECIALIST_ARTIST', 		30),
	('BUILDING_FW_SKYCITY', 			'SPECIALIST_MUSICIAN', 		30),
...
VALUES
	...
	('BUILDING_FW_ECOPOLIS', 		  'FEATURE_MARSH', 'YIELD_CULTURE',    2),
	('BUILDING_FW_ECOPOLIS', 		  'FEATURE_MARSH', 'YIELD_SCIENCE',    1),
	('BUILDING_FW_ECOPOLIS', 		  'FEATURE_MARSH', 'YIELD_PRODUCTION', 1),
	('BUILDING_FW_ECOPOLIS', 		  'FEATURE_MARSH', 'YIELD_TOURISM',    2);
...
INSERT INTO Building_InstantYield
	(BuildingType, 					YieldType, 			Yield)
VALUES
	('BUILDING_FW_BIONICTOWER', 	'YIELD_SCIENCE', 	50000),
	('BUILDING_FW_SKYCITY', 		'YIELD_CULTURE', 	25000),
	('BUILDING_FW_ULTIMATOWER', 	'YIELD_GOLD', 		25000),
...
('BUILDING_FW_ECOPOLIS',  				'FLAVOR_CULTURE',      		40),
('BUILDING_FW_ECOPOLIS',  				'FLAVOR_WONDER',      		25),
('BUILDING_FW_ECOPOLIS',  				'FLAVOR_DEFENSE',      		20),
('BUILDING_FW_ECOPOLIS',  				'FLAVOR_GROWTH',      		15),
('BUILDING_FW_ECOPOLIS',  				'FLAVOR_SCIENCE',      		15),
('BUILDING_FW_ECOPOLIS',  				'FLAVOR_TILE_IMPROVEMENT',  10),
('BUILDING_FW_ECOPOLIS',  				'FLAVOR_PRODUCTION',      	10),
('BUILDING_FW_ECOPOLIS',  				'FLAVOR_HAPPINESS',      	5),
...
('BUILDING_FW_ANGELNET',  				'FLAVOR_AIRLIFT',  			25),
('BUILDING_FW_ANGELNET',  				'FLAVOR_DEFENSE',      		70),
('BUILDING_FW_ANGELNET',  				'FLAVOR_CITY_DEFENSE',  	100),
...
('BUILDING_FW_SHANGHAI_WFC',  			'FLAVOR_GREAT_PEOPLE',      10),
('BUILDING_FW_SHANGHAI_WFC',  			'FLAVOR_HAPPINESS',      	20),
('BUILDING_FW_SHANGHAI_WFC',  			'FLAVOR_WONDER',      		25),
...
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE',  'FLAVOR_MOBILE',      		15),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE',  'FLAVOR_GREAT_PEOPLE',      	20),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE',  'FLAVOR_SCIENCE',      		5),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE',  'FLAVOR_DEFENSE',      		5),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE',  'FLAVOR_OFFENSE', 			10),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE',  'FLAVOR_PRODUCTION', 		10),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE',  'FLAVOR_HAPPINESS',      	45),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE',  'FLAVOR_RELIGION',      		60),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE',  'FLAVOR_MILITARY_TRAINING', 	65),
('BUILDING_FW_SKYNET',  					'FLAVOR_MOBILE',      		10),
...
('BUILDING_FW_SKYNET',  					'FLAVOR_WONDER',      		25),
('BUILDING_FW_SKYNET',  					'FLAVOR_PRODUCTION',      	45),
...
('BUILDING_FW_SKYTREE',        			'FLAVOR_HAPPINESS',      	45),
('BUILDING_FW_SKYTREE',        			'FLAVOR_CULTURE',      		30),
('BUILDING_FW_SKYTREE',        			'FLAVOR_SCIENCE',      		10),
('BUILDING_FW_SKYTREE',        			'FLAVOR_GOLD',      		30),
('BUILDING_FW_JURASSIC_PARK',        	'FLAVOR_GREAT_PEOPLE',      5),
('BUILDING_FW_JURASSIC_PARK',        	'FLAVOR_DEFENSE',      		15),
('BUILDING_FW_JURASSIC_PARK',        	'FLAVOR_WONDER',      		20),
('BUILDING_FW_JURASSIC_PARK',        	'FLAVOR_CULTURE',      		20),
('BUILDING_FW_JURASSIC_PARK',        	'FLAVOR_CITY_DEFENSE',      25),
('BUILDING_FW_JURASSIC_PARK',        	'FLAVOR_SCIENCE',      		30),
('BUILDING_FW_JURASSIC_PARK',        	'FLAVOR_HAPPINESS',      	45),
('BUILDING_FW_FLOATINGISLANDS',        	'FLAVOR_SCIENCE',      		15),
('BUILDING_FW_FLOATINGISLANDS',        	'FLAVOR_NAVAL_TILE_IMPROVEMENT', 15),
...
('BUILDING_FW_BIONICTOWER',        		'FLAVOR_WONDER',      		40),
('BUILDING_FW_BIONICTOWER',        		'FLAVOR_GREAT_PEOPLE',      40),
('BUILDING_FW_BIONICTOWER',        		'FLAVOR_HAPPINESS',      	30),
('BUILDING_FW_BIONICTOWER',        		'FLAVOR_GROWTH',      		50),
('BUILDING_FW_BIONICTOWER',        		'FLAVOR_SCIENCE',      		80),
...
('BUILDING_FW_SKYCITY',        			'FLAVOR_WONDER',      		40),
('BUILDING_FW_SKYCITY',        			'FLAVOR_RELIGION',      	20),
('BUILDING_FW_SKYCITY',        			'FLAVOR_GREAT_PEOPLE',      40),
('BUILDING_FW_SKYCITY',        			'FLAVOR_HAPPINESS',      	30),
('BUILDING_FW_SKYCITY',        			'FLAVOR_CULTURE',      		80),
('BUILDING_FW_ULTIMATOWER',        		'FLAVOR_WONDER',      		40),
('BUILDING_FW_ULTIMATOWER',        		'FLAVOR_GOLD',      		40),
('BUILDING_FW_ULTIMATOWER',        		'FLAVOR_GREAT_PEOPLE',      40),
('BUILDING_FW_ULTIMATOWER',        		'FLAVOR_HAPPINESS',      	30),
('BUILDING_FW_ULTIMATOWER',        		'FLAVOR_GROWTH',      		60),
('BUILDING_FW_ULTIMATOWER',        		'FLAVOR_PRODUCTION',      	80),
('BUILDING_FW_BUENOSAIRESFORUM',        'FLAVOR_CULTURE',      		20),
('BUILDING_FW_BUENOSAIRESFORUM',        'FLAVOR_WONDER',      		40),
('BUILDING_FW_BUENOSAIRESFORUM',        'FLAVOR_GREAT_PEOPLE',      40),
('BUILDING_FW_BUENOSAIRESFORUM',        'FLAVOR_HAPPINESS',   		60),
('BUILDING_FW_BUENOSAIRESFORUM',        'FLAVOR_GOLD',      		80),
