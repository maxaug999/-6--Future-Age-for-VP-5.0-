...
('BUILDING_FW_VIRTUAL_IDOL', 			'TECH_COGNITIVE_TECH',     4500, 'ART_DEF_BUILDING_LABORATORY',  17, 'CIV_COLOR_ATLAS_FW_3', 	1, 29, 		'VirtualIdol_Splash.dds',		 	'L,T'),
('BUILDING_FW_ENRICHMENT_CENTRE', 		'TECH_NUCLEAR_ENRICHMENT', 5000, 'ART_DEF_BUILDING_LABORATORY',  7, 'CIV_COLOR_ATLAS_FW_3', 	1, 29, 		'EnrichmentCentre_Splash.dds',		'L,T'),
('BUILDING_FW_JURASSIC_PARK',     	 	'TECH_CLONING',            5000, 'ART_DEF_BUILDING_LABORATORY',  5,'CIV_COLOR_ATLAS_FW_3', 		1, 32, 		'JurassicPark_Splash.dds', 			'L,T'),
('BUILDING_FW_HELIOS', 					'TECH_ASTRODYNAMICS',      5000, 'ART_DEF_BUILDING_LABORATORY',  19,'CIV_COLOR_ATLAS_FW_2', 	1, 32, 		'Helios_Splash.dds',		 		'L,T'),
('BUILDING_FW_PHOLUS_MUTAGEN', 			'TECH_TRANSGENICS',    	   5750, 'ART_DEF_BUILDING_LABORATORY',  26, 'CIV_COLOR_ATLAS_FW_2', 	1, 32, 		'PholusMutagen_Splash.dds',		 	'L,T'),
('BUILDING_FW_DATA_HAVEN', 	  	  	 	'TECH_AUTONOMOUS_SYSTEMS', 5750, 'ART_DEF_BUILDING_LABORATORY',  3,'CIV_COLOR_ATLAS_FW_2', 		1, 32, 		'DataHaven_Splash.dds', 			'R,B'),
('BUILDING_FW_SHIMIZUMCP', 		  	 	'TECH_ARCOLOGIES',    	   5750, 'ART_DEF_BUILDING_LABORATORY',  16,'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'FWShimizuMCP_Splash.dds', 			'L,T'),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE', 	'TECH_GENGINEERING',       6000, 'ART_DEF_BUILDING_FW_GARDEN',   16,'CIV_COLOR_ATLAS_FW_3', 	1, 34, 		'NephilimGeneTemplate_Splash.dds', 	'L,T'),
('BUILDING_FW_MNEMOSYNE', 				'TECH_CYBERNETICS',    	   6000, 'ART_DEF_BUILDING_LABORATORY',  45, 'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'Mnemosyne_Splash.dds',		 		'L,T'),
('BUILDING_FW_SKYNET', 					'TECH_AI', 	  		 	   6000, 'ART_DEF_BUILDING_LABORATORY',  32,'CIV_COLOR_ATLAS_FW_3', 	1, 34, 		'Skynet_Splash.dds',		 		'L,T'),
('BUILDING_FW_CITADEL_STATION', 		'TECH_NUCLEAR_FUSION',     5750, 'ART_DEF_BUILDING_LABORATORY',  6, 'CIV_COLOR_ATLAS_FW_3', 	1, 34, 		'CitadelStation_Splash.dds',		'R,T'),
-- ('BUILDING_FW_ORBITAL_REFINERY', 		'TECH_ADAMANTIUM',         5500, 'ART_DEF_BUILDING_LABORATORY',  57,'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'OrbitalRefinery_Splash.dds', 		'L,T'),
('BUILDING_FW_FLOATINGISLANDS',   	 	'TECH_TERRAFORMING', 	   7250, 'ART_DEF_BUILDING_LABORATORY',  50,'CIV_COLOR_ATLAS_FW_2', 	1, 35, 		'LivingCity_Splash.dds', 	        'L,T'),
('BUILDING_FW_DIGITAL_EMANCIPATION', 	'TECH_DIGITAL_SOCIETY',    7250, 'ART_DEF_BUILDING_LABORATORY',  43, 'CIV_COLOR_ATLAS_FW_2', 	1, 35, 		'DigitalEmancipation_Splash.dds',	'L,T'),
('BUILDING_FW_ANGELNET', 				'TECH_SMART_MATERIALS',    7250, 'ART_DEF_BUILDING_LABORATORY',  38,'CIV_COLOR_ATLAS_FW_2', 	1, 35, 		'Angelnet_Splash.dds',		 		'L,T'),
('BUILDING_FW_ULTIMATOWER', 	  	 	'TECH_HYPERSTRUCTURES',    7250, 'ART_DEF_BUILDING_LABORATORY',  49,'CIV_COLOR_ATLAS_FW_2', 	1, 35, 		'FWUltimaTower_Splash.dds', 		'L,T'),
('BUILDING_FW_BIONICTOWER', 	  	 	'TECH_HYPERSTRUCTURES',    7250, 'ART_DEF_BUILDING_LABORATORY',  29,'CIV_COLOR_ATLAS_FW_2',		1, 35, 		'FWBionicTower_Splash.dds', 		'C,T'),
('BUILDING_FW_BUENOSAIRESFORUM',  	 	'TECH_HYPERSTRUCTURES',    7250, 'ART_DEF_BUILDING_LABORATORY',  47,'CIV_COLOR_ATLAS_FW_2', 	1, 35, 		'FWBuenosAiresForum_Splash.dds',	'L,T'),
('BUILDING_FW_SKYCITY', 	  	  	 	'TECH_HYPERSTRUCTURES',    7250, 'ART_DEF_BUILDING_LABORATORY',  36,'CIV_COLOR_ATLAS_FW_3', 	1, 35, 		'KingdomTowerCT_Splash.dds', 		'R,T'),
...
-- Move Hubble
UPDATE Buildings
SET PrereqTech = 'TECH_ORBITAL_DEV', Cost = 4500
...
----------------------------------------------
UPDATE Buildings
SET SpecialistType = 'SPECIALIST_ENGINEER', GreatPeopleRateChange = 2, FreeBuildingThisCity = 'BUILDINGCLASS_FW_NANOMAT_PLANT'
...
VALUES		
	...
	('BUILDING_FW_ENRICHMENT_CENTRE',	'IMPROVEMENT_FW_INDUSTRIAL_COMPLEX',        'YIELD_GOLD', 		1),
	...
	('BUILDING_FW_HELIOS', 	            'IMPROVEMENT_FW_HERC',      	            'YIELD_GOLD',    			1),
...
('BUILDING_FW_NANO_INSTITUTE',        	'FLAVOR_SPACESHIP',      	15),
