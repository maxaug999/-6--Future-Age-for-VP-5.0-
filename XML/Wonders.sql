...
('BUILDING_FW_SKYTREE',     	  	 	'TECH_MEMETICS',     	   3500, 'ART_DEF_BUILDING_LABORATORY',  0,'BW_ATLAS_SKYTREE', 	  		1, 28, 		'SkyTree_splash.dds', 				'R,T'),
...
('BUILDING_FW_NANO_INSTITUTE',    	 	'TECH_NANOTECHNOLOGY',     3500, 'ART_DEF_BUILDING_LABORATORY',  17,'CIV_COLOR_ATLAS_FW_2', 	1, 27, 		'SkyTree_splash_a.dds', 			'L,T'),
('BUILDING_FW_GENE_VAULT', 				'TECH_FW_ECOTHEORY',       4000, 'ART_DEF_BUILDING_LABORATORY',  42,'CIV_COLOR_ATLAS_FW_3', 	1, 28, 		'GeneVault_Splash.dds',		 		'L,T'),
...
('BUILDING_FW_VIRTUAL_IDOL', 			'TECH_COGNITIVE_TECH',     4000, 'ART_DEF_BUILDING_LABORATORY',  17, 'CIV_COLOR_ATLAS_FW_3', 	1, 28, 		'VirtualIdol_Splash.dds',		 	'L,T'),
...
('BUILDING_FW_JURASSIC_PARK',     	 	'TECH_CLONING',            4250, 'ART_DEF_BUILDING_LABORATORY',  5,'CIV_COLOR_ATLAS_FW_3', 		1, 30, 		'JurassicPark_Splash.dds', 			'L,T'),
('BUILDING_FW_HELIOS', 					'TECH_ASTRODYNAMICS',      4250, 'ART_DEF_BUILDING_LABORATORY',  19,'CIV_COLOR_ATLAS_FW_2', 	1, 30, 		'Helios_Splash.dds',		 		'L,T'),
('BUILDING_FW_PHOLUS_MUTAGEN', 			'TECH_TRANSGENICS',    	   5000, 'ART_DEF_BUILDING_LABORATORY',  26, 'CIV_COLOR_ATLAS_FW_2', 	1, 30, 		'PholusMutagen_Splash.dds',		 	'L,T'),
('BUILDING_FW_DATA_HAVEN', 	  	  	 	'TECH_AUTONOMOUS_SYSTEMS', 5000, 'ART_DEF_BUILDING_LABORATORY',  3,'CIV_COLOR_ATLAS_FW_2', 		1, 30, 		'DataHaven_Splash.dds', 			'R,B'),
('BUILDING_FW_SHIMIZUMCP', 		  	 	'TECH_ARCOLOGIES',    	   5000, 'ART_DEF_BUILDING_LABORATORY',  16,'CIV_COLOR_ATLAS_FW_2', 	1, 32, 		'FWShimizuMCP_Splash.dds', 			'L,T'),
('BUILDING_FW_NEPHILIM_GENE_TEMPLATE', 	'TECH_GENGINEERING',       5250, 'ART_DEF_BUILDING_FW_GARDEN',   16,'CIV_COLOR_ATLAS_FW_3', 	1, 32, 		'NephilimGeneTemplate_Splash.dds', 	'L,T'),
('BUILDING_FW_MNEMOSYNE', 				'TECH_CYBERNETICS',    	   5250, 'ART_DEF_BUILDING_LABORATORY',  45, 'CIV_COLOR_ATLAS_FW_2', 	1, 32, 		'Mnemosyne_Splash.dds',		 		'L,T'),
('BUILDING_FW_SKYNET', 					'TECH_AI', 	  		 	   5250, 'ART_DEF_BUILDING_LABORATORY',  32,'CIV_COLOR_ATLAS_FW_3', 	1, 32, 		'Skynet_Splash.dds',		 		'L,T'),
('BUILDING_FW_CITADEL_STATION', 		'TECH_NUCLEAR_FUSION',     5250, 'ART_DEF_BUILDING_LABORATORY',  6, 'CIV_COLOR_ATLAS_FW_3', 	1, 32, 		'CitadelStation_Splash.dds',		'R,T'),
...
('BUILDING_FW_FLOATINGISLANDS',   	 	'TECH_TERRAFORMING', 	   6000, 'ART_DEF_BUILDING_LABORATORY',  50,'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'LivingCity_Splash.dds', 	        'L,T'),
('BUILDING_FW_DIGITAL_EMANCIPATION', 	'TECH_DIGITAL_SOCIETY',    6000, 'ART_DEF_BUILDING_LABORATORY',  43, 'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'DigitalEmancipation_Splash.dds',	'L,T'),
('BUILDING_FW_ANGELNET', 				'TECH_SMART_MATERIALS',    6000, 'ART_DEF_BUILDING_LABORATORY',  38,'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'Angelnet_Splash.dds',		 		'L,T'),
('BUILDING_FW_ULTIMATOWER', 	  	 	'TECH_HYPERSTRUCTURES',    6000, 'ART_DEF_BUILDING_LABORATORY',  49,'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'FWUltimaTower_Splash.dds', 		'L,T'),
('BUILDING_FW_BIONICTOWER', 	  	 	'TECH_HYPERSTRUCTURES',    6000, 'ART_DEF_BUILDING_LABORATORY',  29,'CIV_COLOR_ATLAS_FW_2',		1, 34, 		'FWBionicTower_Splash.dds', 		'C,T'),
('BUILDING_FW_BUENOSAIRESFORUM',  	 	'TECH_HYPERSTRUCTURES',    6000, 'ART_DEF_BUILDING_LABORATORY',  47,'CIV_COLOR_ATLAS_FW_2', 	1, 34, 		'FWBuenosAiresForum_Splash.dds',	'L,T'),
('BUILDING_FW_SKYCITY', 	  	  	 	'TECH_HYPERSTRUCTURES',    6000, 'ART_DEF_BUILDING_LABORATORY',  36,'CIV_COLOR_ATLAS_FW_3', 	1, 34, 		'KingdomTowerCT_Splash.dds', 		'R,T'),
...
----------------------------------------------
UPDATE Buildings
SET ProhibitedCityTerrain = 'TERRAIN_COAST', MinAreaSize = 0, SpecialistType = 'SPECIALIST_MERCHANT', GreatPeopleRateChange = 2, TechEnhancedTourism = 3, Happiness = 4, BorderObstacle = 1, FreeBuildingThisCity = 'BUILDINGCLASS_FW_CLONE_LAB', Defense = 1700, ExtraCityHitPoints = 150
...
-- ----------------------------------------------
UPDATE Buildings
SET FreeTechs = 1, FreeBuildingThisCity = 'BUILDINGCLASS_FW_PARTICLE_ACCELERATOR'
...
INSERT INTO Building_YieldPerAlly
			(BuildingType,						YieldType,			Yield)
VALUES		('BUILDING_FW_APEX_CENTRE',			'YIELD_FAITH',		1),
			('BUILDING_FW_APEX_CENTRE',			'YIELD_CULTURE',	1);
			
------------------------
-- Flavors
------------------------
INSERT INTO Building_Flavors (BuildingType, FlavorType, Flavor) VALUES
('BUILDING_FW_APEX_CENTRE',  			'FLAVOR_RELIGION',      	15),
